...
import { d as isLinkLocalIpAddress, g as parseCanonicalIpAddress, o as isCloudMetadataIpAddress } from "./ip-pFPfkB2L.js";
import { c as shouldUseEnvHttpProxyForUrl } from "./proxy-env-DozUctro.js";
import { L as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-C-TGBz6u.js";
import { r as resolveProviderRequestCapabilities } from "./provider-attribution-Cs6Ke5w3.js";
import { c as detectOpenAICompletionsCompat } from "./provider-model-compat-DsjaSJAR.js";
import { c as resolveProviderRequestPolicyConfig, i as mergeModelProviderRequestOverrides, n as buildProviderRequestDispatcherPolicy, r as getModelProviderRequestTransport } from "./provider-request-config-DpVbkDsk.js";
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, m as mergeSsrFPolicies, x as ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist } from "./ssrf-B0MzL7V8.js";
import { a as withTrustedEnvProxyGuardedFetchMode, n as fetchWithSsrFGuard } from "./fetch-guard-D1CgMnja.js";
...
import { i as COPILOT_INTEGRATION_ID, s as buildCopilotIdeHeaders } from "./provider-auth-B6cPYOBn.js";
import { r as resolveDebugProxySettings } from "./env-Bs5DhvnG.js";
import { n as ensureModelProviderLocalService } from "./provider-local-service-BbqXPVBG.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-DhHQAuXG.js";
...
function sanitizeOpenRouterReasoningReplayFields(record) {
	...
	if ("reasoning" in record && typeof record.reasoning !== "string") delete record.reasoning;
...
function normalizeReasoningContentReplayModelId(modelId) {
...
function shouldPreserveReasoningContentReplay(model, compat) {
	...
	return normalizedModelId !== void 0 && REASONING_CONTENT_REPLAY_MODEL_IDS.has(normalizedModelId);
}
