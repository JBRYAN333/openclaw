...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-CrsTNiWV.js";
import { n as channelRouteDedupeKey } from "./channel-route-kKAHigG3.js";
import { n as getLoadedChannelPlugin } from "./registry-B5IDaiMt2.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-CTdP-onY.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-CEJ2zzEu.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-CIZ9kesq.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-NIoSrpQR.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CwOb-03H.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-Dgn4UtVr.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BBq4tBCS.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-RHKypuQu.js";
import { l as roleScopesAllow } from "./pairing-token-Bc9SRvDx.js";
import { c as listDevicePairing, o as hasEffectivePairedDeviceRole } from "./device-pairing-DOIwyAl5.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CrwfiXwG.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CV7UcPOZ.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-Byt1Hc9-.js";
import "./server-aux-methods-B0ckPl9_.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-D1QE_sOw.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-DPGalWv0.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-BQF144qS.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
