...
import { n as resolveNormalizedXaiToolModel, r as resolvePositiveIntegerToolConfig, t as coerceXaiToolConfig } from "./tool-config-shared-B2SOg0UV.js";
import { a as resolveXaiResponseTextCitationsAndInline, n as buildXaiResponsesToolBody, o as resolveXaiResponsesEndpoint } from "./responses-tool-shared-akLXeISZ.js";
...
async function requestXaiXSearch(params) {
	return await postTrustedWebToolsJson({
		...
		return resolveXaiResponseTextCitationsAndInline(await readProviderJsonResponse(response, "xAI X search failed"), params.inlineCitations);
	});
}
//#endregion
