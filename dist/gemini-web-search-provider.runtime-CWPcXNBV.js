...
import { a as createProviderHttpError, l as formatProviderHttpErrorMessage, u as readProviderJsonResponse } from "./provider-http-errors-Di3cFtvs.js";
import { a as wrapWebContent } from "./external-content-C0AQPnRX.js";
import { a as buildUnsupportedSearchFilterResponse, b as withTrustedWebSearchEndpoint, d as readCachedSearchPayload, f as readConfiguredSecretString, g as resolveSearchTimeoutSeconds, h as resolveSearchCount, i as buildSearchCacheKey, l as parseIsoDateRange, m as resolveSearchCacheTtlMs, p as readProviderEnvValue, s as normalizeFreshness, x as writeCachedSearchPayload } from "./web-search-provider-common-CAPa3L2Z.js";
import "./provider-http-ctoH8Sn3.js";
import { r as resolveCitationRedirectUrl } from "./provider-web-search-Bl9sr-1B.js";
import { n as resolveGeminiConfig, r as resolveGeminiModel, t as resolveGeminiBaseUrl } from "./gemini-web-search-provider.shared-BopOm_dj.js";
...
async function runGeminiSearch(params) {
	...
	return withTrustedWebSearchEndpoint({
		...
		const data = await readProviderJsonResponse(res, "Gemini API error");
		if (data.error) {
