...
import { a as resolveAgentDir, i as resolveAgentContextLimits } from "./agent-scope-config-BtdxzKSb.js";
import { m as resolveSessionAgentIds } from "./agent-scope-akHIaV5z.js";
import "./boundary-file-read-wgc2vgUM.js";
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-Zri3jGSq.js";
import { n as replaceFileAtomic } from "./replace-file-DfT5iHv1.js";
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BraeyLpn.js";
...
import { u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { i as ensureGlobalUndiciEnvProxyDispatcher, r as ensureGlobalUndiciDispatcherStreamTimeouts, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-Cf0zNkE6.js";
import { a as hasInterSessionUserProvenance, i as applyInputProvenanceToUserMessage, r as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-CErWh9lp.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DP_hm1Ak.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C4RITkoV.js";
import { a as listRegisteredAgentHarnesses } from "./registry-sjq8TGmI.js";
import { T as getCompactionProvider } from "./loader-LwF2xSS-.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-CxhewCBU.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BErah80O.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BPjDTxSm.js";
import { a as resolveContextEngineOwnerPluginId } from "./registry-C-zAZhPm.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-CksFaaR6.js";
import { u as resolveStorePath } from "./paths--VbI5S8-.js";
import { E as createExpiringMapCache, O as isCacheEnabled, k as resolveCacheTtlMs, t as loadSessionStore } from "./store-load-O_Rv9hrE.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags } from "./paths-CmS1jGLb.js";
import { c as updateSessionStoreEntry, i as runQuotaSuspensionMaintenance } from "./store-BiClsopu.js";
import { m as MAX_IMAGE_BYTES } from "./mime-CpUb3hFF.js";
import { l as redactTranscriptMessage } from "./transcript-u_C4aNAS.js";
...
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-B-4fK6w1.js";
...
import { s as resolveDefaultModelForAgent } from "./model-selection-KS3DWjxX.js";
import { t as stableStringify } from "./stable-stringify-BZf14J43.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DLsHuJmF.js";
import { d as stripRuntimeContextCustomMessages, l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-BwPJYIO9.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-THW_Gsx5.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-Bz7eZbDL.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-B20Kxs27.js";
import { m as parseExecApprovalResultText } from "./sanitize-user-facing-text-DYDcLDnF.js";
import { g as updateActiveEmbeddedRunSnapshot, h as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-wNzsiU6J.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BCIwAAWU.js";
import { C as isStrictAgenticSupportedProviderModel, T as isEmbeddedMode, u as resolveToolLoopDetectionConfig, w as stripProviderPrefix } from "./openclaw-tools-DS4C6iP3.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-C5xmqF2w.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-CeiEL6OQ.js";
import { u as stripHeartbeatToken } from "./heartbeat-C6deZo_P.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-B8T98Nhr.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-n1STq-9p.js";
import { t as getMachineDisplayName } from "./machine-name-BywYDwiO.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CJAZ9XDz.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-Cs6Ke5w3.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DsjaSJAR.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-DPZVaWlQ.js";
import { i as normalizeToolName } from "./tool-policy-shared-Bmd2OpRs.js";
import "./tool-policy-fYoy2PZL.js";
import { i as getPluginToolMeta } from "./tools-DhAnnc4_.js";
import { n as redactConfigObject } from "./redact-snapshot-Dh_uFUvc.js";
import { n as resolveCommitHash } from "./git-commit-BIf5_sAN.js";
import { t as resolveOsSummary } from "./os-summary-D4xi7ZgU.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-9xWb5SGz.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-CyPaKYq1.js";
import { d as parseBooleanValue } from "./frontmatter-Cq_WhyT8.js";
import { i as listActiveProcessSessionReferences } from "./compaction-runtime-context-DbsBXemX.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-DwhShkl4.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Bjff_0oS.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-B4SBOCR2.js";
...
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DwkS9Jj-.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-MgwEdo4a.js";
import { n as extractToolResultId, o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CuxZwc-q.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-C4vJDCIs.js";
import { _ as resolveChannelPromptCapabilities, g as resolveChannelMessageToolHints, h as listChannelSupportedActions, v as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-mfHnb-h9.js";
import { r as optionalStringEnum } from "./typebox-CwlDcf2G.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-CCIisBx8.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-6mCI0klV.js";
...
import { i as resolveOpenClawReferencePaths } from "./docs-path-DzQOPUGX.js";
import { a as isTimeoutError } from "./failover-error-BroxcAu0.js";
import { t as sanitizeForConsole } from "./console-sanitize-CBgd5JeS.js";
import { u as resolveModelAuthMode } from "./model-auth-DEYN7V2A.js";
import { C as isToolResultTimedOut, D as isMessagingTool, E as collectTextContentBlocks, O as isMessagingToolSendAction, S as isToolResultError, T as sanitizeToolResult, _ as extractMessagingToolSend, b as extractToolResultText$1, d as shouldAllowProviderOwnedThinkingReplay, f as logAgentRuntimeToolDiagnostics, g as runAgentCleanupStep, k as supportsModelTools, l as createAgentToolResultMiddlewareRunner, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as normalizeAgentRuntimeTools, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as resolveTranscriptPolicy, v as extractToolErrorMessage, w as sanitizeToolArgs, x as filterToolResultMediaUrls, y as extractToolResultMediaArtifact } from "./attempt.tool-run-context-Da6cUSGm.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-DXaDgD3m.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Bu-Izf7L.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-BwBR0t5N.js";
import "./pi-bundle-mcp-tools-BryQRuC6.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-DdMD9NR1.js";
import { r as parseFenceSpans } from "./fences-Di6_el06.js";
import { t as parseInlineDirectives } from "./directive-tags-BvfxoLLB.js";
import { r as splitMediaFromOutput } from "./parse-k1saxkUC.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-bn3MMxHW.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-BfLx0neg.js";
import { h as parseReplyDirectives } from "./deliver-BWG2CP0S.js";
import { D as formatToolAggregate } from "./channel-streaming-ClXzZKIW.js";
import { l as hasCommittedMessagingToolDeliveryEvidence, m as mediaUrlsFromGeneratedAttachments, u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-E3h6uGdD.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-5UiCkH4G.js";
import { f as buildApiErrorObservationFields, p as buildTextObservationFields } from "./model-fallback-DonaAKJ1.js";
import { t as log$5 } from "./logger-BobAjb7y.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-Cx5dlcnG.js";
import { _ as createPreparedEmbeddedPiSettingsManager, a as computeAdaptiveChunkRatio, c as resolveContextWindowTokens$1, d as resolveLiveToolResultMaxChars, g as formatContextLimitTruncationNotice, h as truncateToolResultMessage, i as SUMMARIZATION_OVERHEAD_TOKENS, l as summarizeInStages, m as truncateOversizedToolResultsInSessionManager, n as shouldPreemptivelyCompactBeforePrompt, o as estimateMessagesTokens, s as pruneHistoryForContextShare, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-DHtSgAp-.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DKLcss0Q.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-CsNtiAVZ.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-BJv-uyer.js";
import { t as resolveAccountEntry } from "./account-lookup-Cf4NKXLX.js";
...
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-CWKAG9Db.js";
import { S as firstEnumerableOwnKeys, w as jsonUtf8BytesOrInfinity, x as boundedJsonUtf8Bytes } from "./session-utils.fs-DHlqTPnd.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-C9LnDFHJ.js";
import { n as buildSubagentList } from "./subagent-list-MEFJs3Lp.js";
import { o as listControlledSubagentRuns } from "./subagent-control-BSz9lxVR.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-D9B9JrLW.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-7Sm4c0cM.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-CzKhB7Vv.js";
import { S as hasCopilotVisionInput, _ as sanitizeTransportPayloadText, h as mergeTransportHeaders, x as buildCopilotDynamicHeaders, y as buildGuardedModelFetch } from "./openai-transport-stream-Dj0EusP2.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-DhHQAuXG.js";
import { o as resolveSandboxContext } from "./sandbox-cufcIOI0.js";
import { a as getRawSessionAppendMessage, l as readTranscriptFileState, o as setRawSessionAppendMessage, s as TranscriptFileState, t as runContextEngineMaintenance, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-CyRJOuDn.js";
import { t as detectRuntimeShell } from "./shell-utils-ChONiZlm.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DNNMFVkP.js";
import { o as loadWorkspaceSkillEntries, s as resolveSkillsPromptForRun } from "./workspace-BAkP6oj6.js";
import "./skills-QcXlunQq.js";
import { n as resolveSystemPromptOverride, t as buildSystemPromptReport } from "./system-prompt-report-BThOiDNK.js";
import { i as resolveUserTimezone } from "./date-time-BUixBxHU.js";
import { n as appendAgentBootstrapSystemPromptSupplement, o as buildSystemPromptParams, r as appendModelIdentitySystemPrompt, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-Ciez-0wA.js";
import "./tool-loop-detection-BYe1nyoX.js";
import { C as isAnthropicModelRef, S as isAnthropicFamilyCacheTtlEligible } from "./proxy-stream-wrappers-Qa82HTPv.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BgoU4_vE.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-qYpItX6o.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-Ba7omXdS.js";
...
import { t as createAnthropicVertexStreamFnForModel } from "./anthropic-vertex-stream-DrEcLxcn.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-CS0aOtZO.js";
import { a as buildAfterTurnRuntimeContext, c as mergeOrphanedTrailingUserPrompt, d as resolveAttemptPrependSystemContext, f as resolvePromptBuildHookResult, g as shouldWarnOnOrphanedUserRepair, h as shouldInjectHeartbeatPrompt, i as shouldPersistCompletedBootstrapTurn, l as prependSystemPromptAddition, m as resolvePromptSubmissionSkipReason, n as composeSystemPromptWithHookContext, o as buildAfterTurnRuntimeContextFromUsage, p as resolvePromptModeForSession, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded, u as resolveAttemptFsWorkspaceOnly } from "./attempt.thread-helpers-UHSiOAs5.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-_dZrpgmn.js";
import { t as detectAndLoadPromptImages } from "./images-B6EuQhdD.js";
import { a as queueRuntimeContextForNextTurn, o as resolveRuntimeContextPromptParts, r as buildRuntimeContextSystemContext, t as buildCurrentTurnPrompt } from "./runtime-context-prompt-CrIqVVV3.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-DJKQi71d.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-mksTaToP.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-CyhTnB8w.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-CZk2nA71.js"));
...
//#endregion
export { resolveReplayInvalidFlag as $, limitHistoryTurns as A, repairSessionFileIfNeeded as B, prewarmSessionFile as C, validateReplayTurns as D, sanitizeSessionHistory as E, consumeCompactionSafeguardCancelReason as F, isLikelyExecutionAckPrompt as G, collectRuntimeChannelCapabilities as H, setCompactionSafeguardCancelReason as I, resolveEmptyResponseRetryInstruction as J, resolveAckExecutionFastPathInstruction as K, compactWithSafetyTimeout as L, hasMeaningfulConversationContent as M, isRealConversationMessage as N, buildEmbeddedMessageActionDiscoveryInput as O, readPostCompactionContext as P, resolveReasoningOnlyRetryInstruction as Q, resolveCompactionTimeoutMs as R, resolveEmbeddedRunSkillEntries as S, createEmbeddedPiResourceLoader as T, STRICT_AGENTIC_BLOCKED_TEXT as U, buildUsageWithNoCost as V, extractPlanningOnlyPlanDetails as W, resolvePlanningOnlyRetryInstruction as X, resolveIncompleteTurnPayloadText as Y, resolvePlanningOnlyRetryLimit as Z, applySystemPromptOverrideToSession as _, formatEmbeddedRunStageSummary as a, isReasoningTagProvider as at, resolveEmbeddedAgentBaseStreamFn as b, rotateTranscriptAfterCompaction as c, dedupeDuplicateUserMessagesForCompaction as d, resolveRunLivenessState as et, flushPendingToolResultsAfterIdle as f, toSessionToolAllowlist as g, collectRegisteredToolNames as h, createEmbeddedRunStageTracker as i, observeReplayMetadata as it, buildEmbeddedExtensionFactories as j, getHistoryLimitFromSessionKey as k, rotateTranscriptFileAfterCompaction as l, collectAllowedToolNames as m, runAgentHarnessAttempt as n, shouldTreatEmptyAssistantReplyAsSilent as nt, shouldWarnEmbeddedRunStageSummary as o, createTrajectoryRuntimeRecorder as ot, mapThinkingLevel as p, resolveAttemptReplayMetadata as q, selectAgentHarness as r, createEmbeddedRunReplayState as rt, resolveBootstrapMode as s, maybeCompactAgentHarnessSession as t, resolveSilentToolResultReplyPayload as tt, shouldRotateCompactionTranscript as u, buildEmbeddedSystemPrompt as v, trackSessionManagerAccess as w, resolveEmbeddedAgentStreamFn as x, createSystemPromptOverride as y, guardSessionManager as z };
