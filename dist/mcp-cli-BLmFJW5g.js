...
import { r as extractFirstTextBlock } from "./chat-message-content-BggZNP3W.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-B5cNPSf3.js"),
			import("./client-d9cDzVTK.js"),
			import("./client-start-readiness-1zRWQR8E.js"),
			import("./method-scopes-CCCNsQ0q.js"),
			import("./client-info-CQ2lZLyc.js")
		]);
