import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-PKkLRXrA.js";
import { r as loadCrestodianOverview } from "./overview-D-B9HMG8.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CwGNaxKM.js")).planCrestodianCommand)({
		input,
		overview
	});
