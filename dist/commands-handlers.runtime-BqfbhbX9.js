...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BtdxzKSb.js";
...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-CAlFSCmN.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DtN_ypvj.js";
...
import { M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, T as validateConfigObjectWithPlugins, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-CG786ii-.js";
import { s as resolveArchiveKind } from "./archive-k5tVcBMG.js";
import "./archive-GqMXPhom.js";
import "./installed-plugin-index-records-DqLKWd_7.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-YIX-oZq0.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-DCDp0VO1.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-kZKOYNjJ.js";
...
import { o as transformConfigFileWithRetry } from "./mutate-DG7j6ueX.js";
import "./config-oTV0PYPe.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DaCJSwhD.js";
import { o as normalizeChannelId } from "./registry-Bd8UHhG1.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-DLWrxK4x.js";
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { i as callGateway } from "./call-BiNMiNMp.js";
import { f as scheduleGatewaySigusr1Restart, h as triggerOpenClawRestart } from "./restart-dp1EyOTH.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-BVtKZVYi.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C4RITkoV.js";
import { t as getActivePluginChannelRegistry } from "./runtime-BPjDTxSm.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DmDUEDU7.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths--VbI5S8-.js";
import { t as loadSessionStore } from "./store-load-O_Rv9hrE.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-B5IDaiMt2.js";
import { s as updateSessionStore } from "./store-BiClsopu.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-CTdP-onY.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-u_C4aNAS.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-C-TGBz6u.js";
...
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-DDBgbrzm.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-THW_Gsx5.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-CrCS1OnH.js";
import "./diagnostic-DHfs4op1.js";
import { h as replyRunRegistry } from "./run-state-Bw-RpzHf.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-BkEn4dMw.js";
import { a as formatEmbeddedPiQueueFailureSummary, f as queueEmbeddedPiMessageWithOutcomeAsync, m as resolveActiveEmbeddedRunSessionId, o as getActiveEmbeddedRunSnapshot, s as isEmbeddedPiRunActive } from "./runs-wNzsiU6J.js";
...
import { r as getSessionBindingService } from "./session-binding-service-B8tjGRXG.js";
import { r as selectAgentHarness } from "./selection-CKLE-ex5.js";
import { r as isSilentReplyPayloadText } from "./tokens-CeiEL6OQ.js";
import { t as formatDurationCompact } from "./format-duration-Ds4Btm62.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-ErJubQR8.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-DwhShkl4.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-Ctskn_oA.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DwkS9Jj-.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-C4vJDCIs.js";
...
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-CMLfaMrn.js";
import { a as clearSessionQueues } from "./queue-CPeuEO_w.js";
import { n as routeReply } from "./route-reply-uIw7_1qp.js";
import { a as resolveContextTokensForModel } from "./context-Bjd1QIR9.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CK3Y0VnC.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, a as getTtsMaxLength, b as setLastTtsAttempt, c as isSummarizationEnabled, f as listTtsPersonas, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, w as setTtsMaxLength, x as setSummarizationEnabled } from "./tts-runtime-Cpi-RFY7.js";
import "./tts-DjmtpvtB.js";
import { t as registerProviderStreamForModel } from "./provider-stream-D9B9JrLW.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-stream-wrappers-CzKhB7Vv.js";
import { a as stripToolResultDetails } from "./session-transcript-repair-DhHQAuXG.js";
import "./sandbox-cufcIOI0.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-BThOiDNK.js";
...
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-D27kFS2Z.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-DUia7deM.js";
import "./commands-registry-CFG-SHhf.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-DtB-1ae1.js";
import { r as resolveModelWithRegistry } from "./model-BmafkJo7.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-CLuIALpO.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-CYu2fH3U.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-XEwgJwYC.js";
...
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-k9igi9l7.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-CLWPVyvA.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-yhg70jDt.js";
import { n as parseActivationCommand } from "./group-activation-BrXx-kCe.js";
import { t as resolveFastModeState } from "./fast-mode-DwJhUMTm.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CnbEBCC6.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CexlOMXc.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-BfA6Uhdj.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-C0zeC9hE.js";
import { t as extractBtwQuestion } from "./btw-command-CrfqsaBo.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DQbDfnCV.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BMBnBAAv.js";
import { t as handleAcpCommand } from "./commands-acp-CVxiVRH4.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-wMt7YO4W.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-LMoEN5ZL.js";
import { r as handleModelsCommand } from "./commands-models-fBohlZIB.js";
import { r as createExecTool } from "./bash-tools-C3_KDx-t.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-C_4yDsY6.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CBwzUC3u.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-RA3fJ94f.js";
import { t as buildToolsMessage } from "./status-Cy_Jkt-a.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-CTSDuP_4.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-D6FhXRao.js";
import "./command-export-ZuXObdBg.js";
import { t as buildStatusReply } from "./commands-status-BN-M92t-.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-CB1JENmM.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-BOtFG8AV.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-DZesCHfX.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-9762AybO.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-tKbh3HCW.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BpfQ9qYZ.js";
import "./clawhub-BX4IgI3P.js";
import { r as installPluginFromClawHub } from "./clawhub-ZTznofiY.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-B_oxosL6.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-D7gsavAQ.js");
		killProcessTree(pid);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BPFckqgs.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-BwFOPdfs.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-BJSl89Ds.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-Dy0OEM7S.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-BoNawhky.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CMjbx8NT.js"));
const actionKillLoader = createLazyImportLoader(() => import("./action-kill-0nc8mk2B.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-CHU-GQ-j.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-DMymbxYK.js"));
const actionSendLoader = createLazyImportLoader(() => import("./action-send-Dg-PE_DF.js"));
const actionSpawnLoader = createLazyImportLoader(() => import("./action-spawn-DsxnZC6I.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-M45Xv1m_.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./commands-subagents-control.runtime-C9I9uEWD.js"));
