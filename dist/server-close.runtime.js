...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-B0VM-4fT.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-wmwjNgDo.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-Bma9Yzpn.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-CZqVFUEd.js");
