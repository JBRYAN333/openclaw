...
import { t as enablePluginInConfig } from "./enable-C0UdzRck.js";
import { n as ensureAuthProfileStore } from "./store-C1ybA4qx.js";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-BAN84w55.js";
import { t as resolveEnvApiKey } from "./model-auth-env-74I_yqVE.js";
import "./workspace-Bjff_0oS.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-CuYEE9Fn.js";
...
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-CFHMv88i.js";
import { r as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-Keg_SiGK.js";
import { n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CuxqfCOK.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CVNYGt3M.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-QcIhjHEd.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-CBmovK_l.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-CiRZw-wQ.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-D_bEkBhU.js");
