...
import { a as resolveAgentDir } from "./agent-scope-config-BtdxzKSb.js";
import { f as resolveRunModelFallbacksOverride, m as resolveSessionAgentIds } from "./agent-scope-akHIaV5z.js";
...
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, x as prepareProviderRuntimeAuth } from "./provider-runtime-C-TGBz6u.js";
...
import { A as limitHistoryTurns, B as repairSessionFileIfNeeded, C as prewarmSessionFile, D as validateReplayTurns, E as sanitizeSessionHistory, F as consumeCompactionSafeguardCancelReason, H as collectRuntimeChannelCapabilities, I as setCompactionSafeguardCancelReason, L as compactWithSafetyTimeout, M as hasMeaningfulConversationContent, N as isRealConversationMessage, O as buildEmbeddedMessageActionDiscoveryInput, R as resolveCompactionTimeoutMs, S as resolveEmbeddedRunSkillEntries, T as createEmbeddedPiResourceLoader, _ as applySystemPromptOverrideToSession, at as isReasoningTagProvider, b as resolveEmbeddedAgentBaseStreamFn, c as rotateTranscriptAfterCompaction, d as dedupeDuplicateUserMessagesForCompaction, f as flushPendingToolResultsAfterIdle, g as toSessionToolAllowlist, h as collectRegisteredToolNames, j as buildEmbeddedExtensionFactories, k as getHistoryLimitFromSessionKey, m as collectAllowedToolNames, p as mapThinkingLevel, u as shouldRotateCompactionTranscript, v as buildEmbeddedSystemPrompt, w as trackSessionManagerAccess, x as resolveEmbeddedAgentStreamFn, y as createSystemPromptOverride, z as guardSessionManager } from "./selection-CKLE-ex5.js";
import { t as getMachineDisplayName } from "./machine-name-BywYDwiO.js";
import { n as extractModelCompat } from "./provider-model-compat-DsjaSJAR.js";
import { i as generateSecureToken } from "./secure-random-CjZPAF5w.js";
import { i as listActiveProcessSessionReferences, n as resolveEmbeddedCompactionTarget } from "./compaction-runtime-context-DbsBXemX.js";
import { a as resolveBootstrapContextForRun, c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-B4SBOCR2.js";
import { f as ensureSessionHeader, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-Ctskn_oA.js";
import { g as resolveChannelMessageToolHints, h as listChannelSupportedActions, v as resolveChannelReactionGuidance } from "./pi-tools.before-tool-call-mfHnb-h9.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-CR1hM8-V.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DzQOPUGX.js";
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-BroxcAu0.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride, u as resolveModelAuthMode } from "./model-auth-DEYN7V2A.js";
import { k as supportsModelTools } from "./attempt.tool-run-context-Da6cUSGm.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-DXaDgD3m.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-BwBR0t5N.js";
import "./pi-bundle-mcp-tools-BryQRuC6.js";
import { r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DonaAKJ1.js";
import { t as log } from "./logger-BobAjb7y.js";
import { _ as createPreparedEmbeddedPiSettingsManager } from "./preemptive-compaction-DHtSgAp-.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DKLcss0Q.js";
import { t as splitSdkTools } from "./tool-split-CsNtiAVZ.js";
import { t as registerProviderStreamForModel } from "./provider-stream-D9B9JrLW.js";
import { i as sanitizeToolUseResultPairing } from "./session-transcript-repair-DhHQAuXG.js";
import { o as resolveSandboxContext } from "./sandbox-cufcIOI0.js";
import { l as readTranscriptFileState, s as TranscriptFileState, u as writeTranscriptFileAtomic } from "./context-engine-maintenance-CyRJOuDn.js";
import { t as detectRuntimeShell } from "./shell-utils-ChONiZlm.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DNNMFVkP.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BAkP6oj6.js";
import "./skills-QcXlunQq.js";
import { n as resolveSystemPromptOverride } from "./system-prompt-report-BThOiDNK.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-BUixBxHU.js";
import { t as applyExtraParamsToAgent } from "./extra-params-BgoU4_vE.js";
