...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-BtdxzKSb.js";
import { p as resolveSessionAgentId } from "./agent-scope-akHIaV5z.js";
import { d as measureDiagnosticsTimelineSpanSync, u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Zri3jGSq.js";
...
import { a as logWarn, t as logDebug } from "./logger-C8cLKnKG.js";
import "./auth-GPf6GUnF.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-CbSoM5QC.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-CG786ii-.js";
import "./archive-k5tVcBMG.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-Bt7Xhwv6.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-C6d1e1fm.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, v as patchPluginSessionExtension, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-LwF2xSS-.js";
import { F as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BPjDTxSm.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DmDUEDU7.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CksFaaR6.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-CN5vNTUW.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CIMqr-Ks.js";
import { h as stringifyRouteThreadId } from "./channel-route-kKAHigG3.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-B7f3sDqS.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths--VbI5S8-.js";
import { t as loadSessionStore } from "./store-load-O_Rv9hrE.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-B5IDaiMt2.js";
import { s as updateSessionStore } from "./store-BiClsopu.js";
import "./plugins-CTdP-onY.js";
import { n as mergeSessionEntry } from "./types-D2bWW4My.js";
import { c as extractDeliveryInfo, i as serializeSessionCleanupResult, o as resolveSessionLifecycleTimestamps, r as runSessionsCleanup, s as resolveMainSessionKeyFromConfig, t as purgeAgentSessionStoreEntries } from "./sessions-4cL7r5Dz.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-ADdTGirH.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-CdCbcLsX.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Ci_wihFp.js";
import { d as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-DkgaMdkF.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BAN84w55.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DLsHuJmF.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-Dp8QFqqM.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-nJrj4YO_.js";
import { t as extractToolPayload } from "./tool-payload-BPFzWQvZ.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-CrCS1OnH.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-BUgA9Jh8.js";
import "./runtime-internal-BcWtTOJZ.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-BI1eJiqi.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-Bw-RpzHf.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-DIqXAABs.js";
import { n as abortEmbeddedPiRun, s as isEmbeddedPiRunActive, v as waitForEmbeddedPiRunEnd } from "./runs-wNzsiU6J.js";
import { n as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-D53QReqR.js";
import { c as resolveRestartSentinelPath, d as writeRestartSentinel, r as formatDoctorNonInteractiveHint } from "./restart-sentinel-9OfUSqSe.js";
import { l as getTotalQueueSize } from "./command-queue-CHbM65cH.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-DJc-3T3E.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DXDrKM63.js";
import { l as normalizeCronJobPatch, s as normalizeCronJobCreate } from "./openclaw-tools-DS4C6iP3.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Bmd2OpRs.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-DhAnnc4_.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-Dh_uFUvc.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Bjff_0oS.js";
import { i as resolveSandboxConfigForAgent } from "./config-YgW65uIq.js";
import { a as isTimeoutError } from "./failover-error-BroxcAu0.js";
import "./auth-profiles-B6McMKCg.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-Ct7NBJ-y.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CqGUXEGc.js";
import { i as createOutboundPayloadPlan, u as projectOutboundPayloadPlanForMirror } from "./deliver-BWG2CP0S.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CEJ2zzEu.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-CIZ9kesq.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-D_g5wFc8.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun, r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-Cjas8Qby.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CZMuowv-.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-C8vTheSN.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-DAFxmY0g.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-DdyMMB0a.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-CoB9MdxI.js";
import { c as dispatchChannelMessageAction, i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry } from "./message-action-runner-sZg9zPLi.js";
import { s as resolveTrustedGroupId } from "./pi-tools.policy-C032Ahdn.js";
import { n as normalizePollInput } from "./polls-DC0qR27K.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-BKlIWRlM.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BrLHcTmG.js";
import "./target-resolver-DF3YEKAs.js";
import { i as resolveReplyToMode } from "./reply-threading-CknTdfYj.js";
import { t as sendDurableMessageBatch } from "./send--6ahIVoQ.js";
import "./runtime-DVYpMLHf.js";
import { t as buildOutboundSessionContext } from "./session-context-Buj28uA7.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-3OXh29M7.js";
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-ByyBz2EU.js";
import { r as resolveOutboundTarget } from "./targets-Bv0k57D_.js";
import { a as clearSessionQueues } from "./queue-CPeuEO_w.js";
import { n as resolveAgentIdentity } from "./identity-dWzSsjKE.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-biJuOiX4.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-BhveTD0t.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-BrzrLQhb.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-DHlqTPnd.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-CjLuSa27.js";
...
import { C as setTtsEnabled, E as setTtsProvider, O as synthesizeSpeech, T as setTtsPersona, _ as resolveTtsConfig, f as listTtsPersonas, g as resolveTtsAutoMode, h as resolveExplicitTtsOverrides, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsPrefsPath, y as resolveTtsProviderOrder } from "./tts-runtime-Cpi-RFY7.js";
import "./tts-DjmtpvtB.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-BAkP6oj6.js";
import "./skills-QcXlunQq.js";
import { n as resolveSendPolicy } from "./send-policy-PZV94jMa.js";
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-jx5E1Un6.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-DFOsNkI0.js";
import "./commands-registry-CFG-SHhf.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-D_lJuELb.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-Bi8ihluc.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-3IuI2ar7.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-BwFMhTVa.js";
import "./browser-maintenance-CG2AkfCP.js";
import { c as performGatewaySessionReset } from "./session-reset-service-wmwjNgDo.js";
import { t as getPluginCommandSpecs } from "./command-specs-G7mHPSs7.js";
import { r as listPluginCommands } from "./commands-ChanGqcV.js";
import { t as getChannelActivity } from "./channel-activity-CDUK2MIS.js";
import { t as WizardCancelledError } from "./prompts-CdKnPdnC.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-CXF55UoG.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-C0zeC9hE.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-B2S4Tx19.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-BhfR1QyX.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-Nw3PNCQL.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-BAD-Hosl.js";
import { r as agentCommandFromIngress } from "./agent-command-Ci4gKYer.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-DwUb-qqR.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DTnB7VKj.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CVsSvJ-I.js";
import { t as formatForLog } from "./ws-log-B_5QSG1K.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-DH7vTgQI.js";
...
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Bu3xUKVR.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, t as getRemoteSkillEligibility } from "./skills-remote-DrTEeASv.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-LMoEN5ZL.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-D4g6UEle.js";
import { a as getPendingDevicePairing, c as listDevicePairing, d as removePairedDevice, h as summarizeDeviceTokens, i as getPairedDevice, m as rotateDeviceToken, o as hasEffectivePairedDeviceRole, p as revokeDeviceToken, r as formatDevicePairingForbiddenMessage, t as approveDevicePairing, u as rejectDevicePairing } from "./device-pairing-DOIwyAl5.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-3htdbzzw.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-BS7_xK3h.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-P5RxEATd.js";
import { n as createOutboundSendDeps } from "./deps-BHDMPtgP.js";
import "./agent-BPBtHd9i.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-DRkezwEU.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-ovdaMWF3.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-15ly--eI.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-B4eBuAlf.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-ByQBr0bU.js";
import "./server-constants-Rkorv3Ve.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-CiYH2AbB.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BHYS9ooz.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-2wbAd4vH.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-CVLmVxRc.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-DgFs--jN.js";
import { t as loadProviderUsageSummary } from "./provider-usage-BW5mH63R.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-C_4yDsY6.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-BX4IgI3P.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-B_oxosL6.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BRR7ZCec.js";
import { t as buildChannelUiCatalog } from "./catalog-FhJ6xOvb.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CI6DBPji.js";
import { s as normalizeUpdateChannel } from "./update-channels-BFcNhUpT.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-npxK1GXa.js";
import { t as readConfiguredLogTail } from "./log-tail-CPVwAw6F.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Dia_IzbK.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-j6jD5JHb.js";
import { t as buildChannelAccountSnapshot } from "./status-Df5LucY3.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DdwB2GA-.js";
import { t as installSkill } from "./skills-install-TxnXGdxe.js";
import { r as readPackageVersion } from "./package-json-B9OWecZg.js";
import { l as buildUpdateRestartSentinelPayload, r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-Q_wx-O-s.js";
import { t as getStatusSummary } from "./status.summary-BgnHfPov.js";
import "./status-BQK79m1x.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-BzheeiOG.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-uIfTJgkr.js";
import { t as MANAGED_SERVICE_UPDATE_HANDOFF_TEMP_PREFIX } from "./update-managed-service-handoff-cleanup-BBeuTcNL.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-B9JL2MZE.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-BcyXDUGr.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-CyX2PTPB.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CY0E46fa.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CrwfiXwG.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CV7UcPOZ.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-DvM7hntn.js";
import "./heartbeat-runner-BRYivrHr.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-CMq4NA88.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-DjjefiRV.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-BjNdXW8f.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BKKDxuHW.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-CGBTlv3P.js";
import { o as resolveApprovalRequestRecipientConnIds } from "./approval-shared-7AauosAj.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-zyxehnmC.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-Bi1aiWVZ.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-DbfeTupd.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-tfCqh9sQ.js");
