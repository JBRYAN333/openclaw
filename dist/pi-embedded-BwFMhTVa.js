...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BtdxzKSb.js";
import { m as resolveSessionAgentIds, r as resolveAgentExecutionContract, t as hasConfiguredModelFallbacks } from "./agent-scope-akHIaV5z.js";
...
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-B9-k7vDU.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-H8ims5ZA.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-C1ybA4qx.js";
import { c as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-BVtKZVYi.js";
...
import { a as resolveContextEngineOwnerPluginId, i as resolveContextEngine } from "./registry-C-zAZhPm.js";
import { s as emitAgentPlanEvent } from "./agent-events-CksFaaR6.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-BggZNP3W.js";
import { X as resolveProviderAuthProfileId, x as prepareProviderRuntimeAuth } from "./provider-runtime-C-TGBz6u.js";
...
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DYDcLDnF.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-DmPUztQf.js";
import "./runs-wNzsiU6J.js";
import { i as enqueueCommandInLane } from "./command-queue-CHbM65cH.js";
import { a as hasReplyPayloadContent } from "./payload-BOSZjzIU.js";
import { S as isStrictAgenticExecutionContractActive, u as resolveToolLoopDetectionConfig } from "./openclaw-tools-DS4C6iP3.js";
import { $ as resolveReplayInvalidFlag, J as resolveEmptyResponseRetryInstruction, K as resolveAckExecutionFastPathInstruction, Q as resolveReasoningOnlyRetryInstruction, U as STRICT_AGENTIC_BLOCKED_TEXT, W as extractPlanningOnlyPlanDetails, X as resolvePlanningOnlyRetryInstruction, Y as resolveIncompleteTurnPayloadText, Z as resolvePlanningOnlyRetryLimit, a as formatEmbeddedRunStageSummary, et as resolveRunLivenessState, i as createEmbeddedRunStageTracker, it as observeReplayMetadata, l as rotateTranscriptFileAfterCompaction, n as runAgentHarnessAttempt, nt as shouldTreatEmptyAssistantReplyAsSilent, o as shouldWarnEmbeddedRunStageSummary, q as resolveAttemptReplayMetadata, r as selectAgentHarness, rt as createEmbeddedRunReplayState, t as maybeCompactAgentHarnessSession, tt as resolveSilentToolResultReplyPayload, u as shouldRotateCompactionTranscript } from "./selection-CKLE-ex5.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-CeiEL6OQ.js";
...
import { i as listActiveProcessSessionReferences, n as resolveEmbeddedCompactionTarget, r as resolveContextEngineCapabilities, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-DbsBXemX.js";
import { o as normalizeTextForComparison, r as pickFallbackThinkingLevel } from "./pi-embedded-helpers-Ctskn_oA.js";
import { a as formatAssistantErrorText, b as parseImageSizeError, c as isBillingAssistantError, f as isFailoverAssistantError, h as isRateLimitAssistantError, i as extractObservedOverflowTokenCount, m as isLikelyContextOverflowError, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, y as parseImageDimensionError } from "./errors-MgwEdo4a.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-CR1hM8-V.js";
import { n as coerceToFailoverError, r as describeFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-BroxcAu0.js";
import "./auth-profiles-B6McMKCg.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-DPONMPot.js";
import { t as markAuthProfileSuccess } from "./profiles-D_RgQyp0.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-DpVbkDsk.js";
import { t as redactIdentifier } from "./redact-identifier-1ybS6cnF.js";
import { t as sanitizeForConsole } from "./console-sanitize-CBgd5JeS.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-n48YFMUg.js";
import { f as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-DEYN7V2A.js";
import { g as runAgentCleanupStep } from "./attempt.tool-run-context-Da6cUSGm.js";
import { c as retireSessionMcpRuntime, l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-Bu-Izf7L.js";
import "./pi-bundle-mcp-tools-BryQRuC6.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-DdMD9NR1.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-C_BSOqDJ.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-bn3MMxHW.js";
import { i as setReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-BfLx0neg.js";
...
import { u as hasMessagingToolDeliveryEvidence } from "./subagent-announce-delivery-E3h6uGdD.js";
import { a as suspendSession, c as resolveSessionKeyForRequest, d as shouldAllowCooldownProbeForReason, f as buildApiErrorObservationFields, i as resolveSessionSuspensionReason, l as resolveStoredSessionKeyForSessionId, u as LiveSessionModelSwitchError } from "./model-fallback-DonaAKJ1.js";
import { t as log$1 } from "./logger-BobAjb7y.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-Cx5dlcnG.js";
import { d as resolveLiveToolResultMaxChars, f as sessionLikelyHasOversizedToolResults, p as truncateOversizedToolResultsInSession } from "./preemptive-compaction-DHtSgAp-.js";
import "./tool-split-CsNtiAVZ.js";
import { n as sleepWithAbort } from "./backoff-BiVbvzJx.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-D7otMhSh.js";
import { t as ensureContextEnginesInitialized } from "./init-C5682Sdy.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-CyRJOuDn.js";
import "./extra-params-BgoU4_vE.js";
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-Ba7omXdS.js";
import { s as forgetPromptBuildDrainCacheForRun } from "./attempt.thread-helpers-UHSiOAs5.js";
...
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-DRpEfBX1.js";
import { n as resolveModelAsync } from "./model-BmafkJo7.js";
import { n as shouldSwitchToLiveModel, r as ensureSelectedAgentHarnessPlugin, t as clearLiveModelSwitchPending } from "./live-model-switch-C9TaDT_M.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DGs-kxWr.js";
import { r as buildAgentRuntimePlan } from "./build-CFVwVFet.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-Ds55mJwt.js";
