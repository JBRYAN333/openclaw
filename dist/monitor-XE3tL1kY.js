...
import { c as kindFromMime, n as detectMime } from "./mime-CpUb3hFF.js";
...
import { n as estimateBase64DecodedBytes } from "./base64-lgTM7tOY.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-FYSjCk2V.js";
...
import { i as resolveSignalAccount } from "./accounts-BTnWRiDe.js";
import { a as normalizeSignalAllowRecipient, c as resolveSignalSender, d as normalizeSignalMessagingTarget, i as isSignalSenderAllowed, l as looksLikeUuid, n as formatSignalSenderDisplay, o as resolveSignalPeerId, r as formatSignalSenderId, s as resolveSignalRecipient, t as formatSignalPairingIdLine } from "./identity-CTFOi5ae.js";
import { n as signalRpcRequest, r as streamSignalEvents, t as signalCheck } from "./client-adapter-qvPaBgDo.js";
...
function createSignalEventHandler(deps) {
	async function handleSignalInboundMessage(entry) {
		...
		const inboundHistory = entry.isGroup && historyKey && deps.historyLimit > 0 ? buildInboundHistoryFromMap({
			historyMap: deps.groupHistories,
			historyKey,
			limit: deps.historyLimit
		}) : void 0;
