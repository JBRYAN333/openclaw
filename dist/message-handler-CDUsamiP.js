...
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-BlyVdi7u.js";
import { i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-DVCT1cPn.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin } from "./auth-GPf6GUnF.js";
import { i as getRuntimeConfig } from "./io-CG786ii-.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-CjEqdugM.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DLWrxK4x.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-DJ_Z5Nbn.js";
import { c as buildDeviceAuthPayloadV3, o as gatewayStartupUnavailableDetails, s as buildDeviceAuthPayload } from "./client-Dw9CM1kL.js";
import { t as rawDataToString } from "./ws-D2BLd9eD.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CjqZOJok.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-G38VuP_R.js";
import { At as validateRequestFrame, M as validateConnectParams, Ni as ErrorCodes, Pi as errorShape, t as formatValidationErrors } from "./protocol-aiM-cUL5.js";
import "./version-COiFfXnY.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import "./method-scopes-CEFheFOv.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-CSosmCqV.js";
import { a as indexPluginNodeCapabilitySurfaces, l as resolvePluginNodeCapabilityTtlMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl, u as setClientPluginNodeCapability } from "./plugin-node-capability-DwUb-qqR.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-DTnB7VKj.js";
import { n as logWs, t as formatForLog } from "./ws-log-B_5QSG1K.js";
import { l as roleScopesAllow } from "./pairing-token-Bc9SRvDx.js";
import { c as updatePairedNodeMetadata, n as getPairedNode, s as requestNodePairing } from "./node-pairing-Bu3xUKVR.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./skills-remote-DrTEeASv.js";
import { a as restoreDeviceBootstrapToken, c as verifyDeviceBootstrapToken, i as redeemDeviceBootstrapTokenProfile, n as getDeviceBootstrapTokenProfile, o as revokeDeviceBootstrapToken } from "./device-bootstrap-CNKcH8ny.js";
import { _ as verifyDeviceToken, c as listDevicePairing, f as requestDevicePairing, g as updatePairedDeviceMetadata, i as getPairedDevice, l as listEffectivePairedDeviceRoles, n as ensureDeviceToken, o as hasEffectivePairedDeviceRole, s as listApprovedPairedDeviceRoles, t as approveDevicePairing } from "./device-pairing-DOIwyAl5.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BTrLYw8W.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-Rkorv3Ve.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DjjefiRV.js";
import { r as upsertPresence } from "./system-presence-BjNdXW8f.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-m44EbSNw.js";
import { c as roleCanSkipDeviceIdentity, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BKKDxuHW.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-D3uh5J48.js";
import { t as truncateCloseReason } from "./close-reason-xSoEN_gc.js";
...
function resolvePinnedClientMetadata(params) {
	...
	return {
		platformMismatch: hasPinnedPlatform && claimedPlatform !== pairedPlatform && !isLegacyNodeHostPlatformPin,
		deviceFamilyMismatch: hasPinnedDeviceFamily && claimedDeviceFamily !== pairedDeviceFamily,
		pinnedPlatform: hasPinnedPlatform && claimedPlatform === pairedPlatform ? params.pairedPlatform : void 0,
...
function attachGatewayWsMessageHandler(params) {
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			(async () => {
				const { handleGatewayRequest } = await import("./server-methods-WBDYfWPF.js");
