...
import { a as getImageMetadata, l as resizeToJpeg, r as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-l_NaT_uv.js";
import { a as ensureMediaDir, u as saveMediaBuffer } from "./store-DN2p1HDW.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, N as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, d as parseBrowserHttpUrl, f as redactCdpUrl, n as assertCdpEndpointAllowed, p as withCdpSocket } from "./cdp.helpers-gBbWhptj.js";
import { a as BrowserProfileUnavailableError, c as BrowserTabNotFoundError, d as toBrowserErrorResponse, i as BrowserProfileNotFoundError, l as BrowserTargetAmbiguousError, n as BrowserConflictError, r as BrowserError, u as BrowserValidationError } from "./errors-CI_4JAQw.js";
import { a as DEFAULT_DOWNLOAD_DIR, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR } from "./config-BIrKlMMb.js";
import "./config-C-BY8QkH.js";
import "./errors-nN38Zwo_.js";
import { i as isValidProfileName, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-Bjlr58-Z.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-DmSpmX1t.js";
import { n as normalizeString } from "./record-shared-kuim4AZH.js";
import "./sdk-setup-tools-B7vzJJC5.js";
import { t as movePathToTrash } from "./trash-DPZbDT9_.js";
import { E as uploadChromeMcpFile, T as takeChromeMcpSnapshot, _ as navigateChromeMcpPage, a as closeChromeMcpTab, c as evaluateChromeMcpScript, f as getChromeMcpPid, l as fillChromeMcpElement, m as hoverChromeMcpElement, n as clickChromeMcpCoords, o as dragChromeMcpElement, r as clickChromeMcpElement, u as fillChromeMcpForm, w as takeChromeMcpScreenshot, x as resizeChromeMcpPage, y as pressChromeMcpKey } from "./chrome-mcp-DOqCcFui.js";
import { E as withBrowserNavigationPolicy, S as assertBrowserNavigationAllowed, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, b as resolveBrowserNavigationProxyMode, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, w as assertBrowserNavigationResultAllowed, y as ensureOutputDirectory } from "./chrome-CZ16ghnE.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-BoSK1SNW.js";
import { c as ACT_MAX_CLICK_DELAY_MS, l as ACT_MAX_WAIT_TIME_MS, o as normalizeBrowserFormField, p as matchBrowserUrlPattern, r as getRoleSnapshotStats, u as normalizeActBoundedNonNegativeMs } from "./pw-role-snapshot-WbKExBSo.js";
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-Bi55J2HW.js");
