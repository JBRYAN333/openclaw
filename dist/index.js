#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-s6LAmrhz.js";
import { t as formatCliFailureLines } from "./failure-output-BRiWI7Z2.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-B_YrxIgH.js";
import { t as isMainModule } from "./is-main-myFrAEl9.js";
import { c as isUncaughtExceptionHandled, r as isBenignUncaughtExceptionError, t as installUnhandledRejectionHandler } from "./unhandled-rejections-CBMu22qg.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-CKGIHm6f.js"));
if (isMain) {
