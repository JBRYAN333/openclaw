...
import { t as getActiveMatrixClient } from "./active-client-D9RulsSC.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-JEnPbT8m.js"), import("./shared-B_XOLkGb.js")]).then(([clientModule, sharedModule]) => ({
