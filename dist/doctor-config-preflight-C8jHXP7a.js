...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-CG786ii-.js";
import { n as formatConfigIssueLines } from "./issue-format-yh3srOrh.js";
import { t as note } from "./note-DagUHZ2d.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-Cn0iUpzq.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-CA21_OzK.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DXJuTo0f.js");
