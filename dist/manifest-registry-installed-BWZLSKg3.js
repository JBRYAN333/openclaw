import { o as tracePluginLifecyclePhase, r as normalizePluginDependencySpecs } from "./discovery-BWp4jfQn.js";
import { h as extractPluginInstallRecordsFromInstalledPluginIndex, y as hashJson } from "./installed-plugin-index-store-BqULksTF.js";
import { u as tryReadJsonSync } from "./json-files-1SmAauRO.js";
import { r as getPackageManifestMetadata, t as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-DfoVCJzr.js";
...
function resolvePackageJsonPath(record) {
	...
	if (!isRelativePathInsideOrEqual(path.relative(rootDir, packageJsonPath))) return;
...
function resolveInstalledPackageMetadata(record) {
	...
	if (!isRelativePathInsideOrEqual(path.relative(rootDir, packageJsonPath))) return fallbackPackageManifest ? { packageManifest: fallbackPackageManifest } : {};
