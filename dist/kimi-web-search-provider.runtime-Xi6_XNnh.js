...
import { a as createProviderHttpError, u as readProviderJsonResponse } from "./provider-http-errors-Di3cFtvs.js";
import { a as wrapWebContent } from "./external-content-C0AQPnRX.js";
import { a as buildUnsupportedSearchFilterResponse, b as withTrustedWebSearchEndpoint, d as readCachedSearchPayload, f as readConfiguredSecretString, g as resolveSearchTimeoutSeconds, h as resolveSearchCount, i as buildSearchCacheKey, m as resolveSearchCacheTtlMs, p as readProviderEnvValue, x as writeCachedSearchPayload } from "./web-search-provider-common-CAPa3L2Z.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import "./provider-http-ctoH8Sn3.js";
import { a as setProviderWebSearchPluginConfigValue, i as resolveProviderWebSearchPluginConfig, r as mergeScopedSearchConfig } from "./web-search-provider-config-qFswhz4b.js";
import "./provider-web-search-Bl9sr-1B.js";
import { n as MOONSHOT_CN_BASE_URL, o as isNativeMoonshotBaseUrl, r as MOONSHOT_DEFAULT_MODEL_ID, t as MOONSHOT_BASE_URL } from "./provider-catalog-B_XKv8Jc.js";
...
async function runKimiSearch(params) {
	...
	for (let round = 0; round < 3; round += 1) {
		const next = await withTrustedWebSearchEndpoint({
			...
			const data = await readProviderJsonResponse(res, "Kimi API error");
