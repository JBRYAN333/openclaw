...
import { p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-akHIaV5z.js";
...
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-YIX-oZq0.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-DoZeWtRv.js";
import "./config-oTV0PYPe.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { l as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-BVtKZVYi.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C4RITkoV.js";
import { x as resolveMemoryFlushPlan } from "./memory-state-B2vT9qvR.js";
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CksFaaR6.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths--VbI5S8-.js";
import { t as loadSessionStore } from "./store-load-O_Rv9hrE.js";
import { c as updateSessionStoreEntry, g as resolveGroupSessionKey, s as updateSessionStore } from "./store-BiClsopu.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-D2bWW4My.js";
import "./sessions-4cL7r5Dz.js";
import { o as isAudioFileName } from "./mime-CpUb3hFF.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-DkgaMdkF.js";
import { t as isCliProvider } from "./model-selection-cli-DAWzmdF4.js";
import "./model-selection-KS3DWjxX.js";
import { r as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-D1g23ycb.js";
import { a as enqueueSystemEvent } from "./system-events-nJrj4YO_.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-DtiLD54J.js";
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-B20Kxs27.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-DYDcLDnF.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-DmPUztQf.js";
import { h as replyRunRegistry, s as ReplyRunAlreadyActiveError, u as createReplyOperation } from "./run-state-Bw-RpzHf.js";
import { a as formatEmbeddedPiQueueFailureSummary, f as queueEmbeddedPiMessageWithOutcomeAsync } from "./runs-wNzsiU6J.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CHbM65cH.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-F6V6NYct.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BCIwAAWU.js";
import { G as isLikelyExecutionAckPrompt, P as readPostCompactionContext } from "./selection-CKLE-ex5.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-CeiEL6OQ.js";
import { u as stripHeartbeatToken } from "./heartbeat-C6deZo_P.js";
import { a as generateSecureUuid } from "./secure-random-CjZPAF5w.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-DwhShkl4.js";
import "./pi-embedded-helpers-Ctskn_oA.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-C1LFuSJ3.js";
...
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-MgwEdo4a.js";
import { u as resolveModelAuthMode } from "./model-auth-DEYN7V2A.js";
import { i as setReplyPayloadMetadata, n as getReplyPayloadMetadata, r as markReplyPayloadForSourceSuppressionDelivery, t as copyReplyPayloadMetadata } from "./reply-payload-BfLx0neg.js";
import { h as parseReplyDirectives } from "./deliver-BWG2CP0S.js";
import { r as runWithModelFallback, t as isFallbackSummaryError, u as LiveSessionModelSwitchError } from "./model-fallback-DonaAKJ1.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-Cx5dlcnG.js";
import { o as estimateMessagesTokens } from "./preemptive-compaction-DHtSgAp-.js";
import { a as applyReplyThreading, i as applyReplyTagsToPayload, s as isRenderablePayload, t as resolveSilentReplyPolicy } from "./silent-reply-BNC0TDR-.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-CknTdfYj.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-DaRIkV8V.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-CPeuEO_w.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-uIw7_1qp.js";
import { a as resolveContextTokensForModel } from "./context-Bjd1QIR9.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CK3Y0VnC.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-DHlqTPnd.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-CjLuSa27.js";
...
import { t as runEmbeddedPiAgent } from "./pi-embedded-BwFMhTVa.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-CFVwVFet.js";
import { r as enqueueCommitmentExtraction } from "./runtime-DQjq0GQ5.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BuoZ_EY1.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-28ZhoGTM.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-uPfi_WMC.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-yQ1geeQL.js";
import { s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-60a8I8yg.js";
import { t as runCliAgent } from "./cli-runner-DVeqv8ZC.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CSypX4lv.js";
import { t as formatProviderModelRef } from "./model-runtime-CV__187M.js";
import "./fallback-notice-state-DUW9JV6z.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CBwzUC3u.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-Brshcaop.js";
...
const piEmbeddedRuntimeLoader = createLazyImportLoader(() => import("./pi-embedded-BvjbT30m.js"));
