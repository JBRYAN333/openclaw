...
import { f as renderMessagePresentationFallbackText, l as normalizeMessagePresentation } from "./payload-BOSZjzIU.js";
...
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CMLfaMrn.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import { n as describeAccountSnapshot } from "./account-helpers-DogjY_xa.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-B8QH4qMk.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-D3hKUEkW.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BQNfKSOi.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Cq69rTZT.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-Dci2Ztph.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-C1zmhCUm.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-bNjJUh2v.js";
import { n as createFeishuSendReceipt } from "./send-result-IyR520Zk.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-T9c2aAar.js";
import { t as messageActionTargetAliases } from "./security-audit-BfBuruZ6.js";
import { o as resolveFeishuGroupToolPolicy } from "./policy-7lXRDlwc.js";
...
import { t as resolveFeishuSessionConversation } from "./session-conversation-DZBARTJl.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-CKHLKvZo.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-CKHLKvZo.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-B467J5Ey.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BkFukf1q.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-Kf69L8_C.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-q-XVsr10.js");
