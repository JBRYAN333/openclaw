...
import { i as getChildLogger, v as normalizeLogLevel } from "../../logger-CcHExlnD.js";
import { a as shouldLogVerbose } from "../../globals-DWuYrGxY.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-YIX-oZq0.js";
...
import { i as resolveSessionFilePath, u as resolveStorePath } from "../../paths--VbI5S8-.js";
import { t as loadSessionStore } from "../../store-load-O_Rv9hrE.js";
import { a as saveSessionStore, c as updateSessionStoreEntry, s as updateSessionStore } from "../../store-BiClsopu.js";
import { _ as mediaKindFromMime, n as detectMime } from "../../mime-CpUb3hFF.js";
...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-DkgaMdkF.js";
import { m as resolveThinkingDefault } from "../../model-selection-KS3DWjxX.js";
import { t as resolveAgentTimeoutMs } from "../../timeout-DLsHuJmF.js";
import { o as requestHeartbeat } from "../../heartbeat-wake-Dp8QFqqM.js";
import { a as enqueueSystemEvent } from "../../system-events-nJrj4YO_.js";
import { p as listTasksForFlowId } from "../../task-registry-BUgA9Jh8.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-CLCICUEb.js";
import "../../runtime-internal-BcWtTOJZ.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-DJi3PKpA.js";
import { a as listRuntimeMusicGenerationProviders, i as generateMusic } from "../../openclaw-tools-DS4C6iP3.js";
import { l as ensureAgentWorkspace } from "../../workspace-Bjff_0oS.js";
import { a as getImageMetadata, l as resizeToJpeg } from "../../image-ops-l_NaT_uv.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "../../lazy-runtime-CuYEE9Fn.js";
...
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-BaDpERsw.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-DzAOlN9a.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-BSmmKc4i.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-BebVZAVc.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-DRChnGGQ.js";
import { r as isVoiceCompatibleAudio } from "../../audio-CMlhF2NC.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-Cd1yu6Qd.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CvBUnKIp.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-Dv1H1aOQ.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-CPs0NGZ2.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-BbUflzXp.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-BKUATmQk.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-CrOkpH3q.js"), (m) => m.createRuntimeLlm({
