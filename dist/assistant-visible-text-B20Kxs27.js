...
import { r as stripPlainTextToolCallBlocks } from "./tool-payload-BPFzWQvZ.js";
...
function stripToolCallXmlTags(text, options = {}) {
	...
	for (let idx = 0; idx < text.length; idx += 1) {
		...
		if (!inToolCallBlock) {
			...
			const shouldStripStandaloneResult = tag.tagName === "function_response" && isStandaloneOpeningTagLine(text, idx, tag);
