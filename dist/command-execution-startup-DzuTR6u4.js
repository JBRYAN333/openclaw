...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-zg_R_ZLD.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-D2fNsxx7.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-BOTFSvvR.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CB_EESC9.js");
	if (params.argv) {
