...
import { r as normalizeChatChannelId } from "./ids-BVSx14Cr.js";
import { i as setPathExistingStrict } from "./path-utils-DGLwtfc0.js";
import { n as discoverConfigSecretTargets } from "./target-registry-BI5_8lLP.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-CG786ii-.js";
import { n as formatConfigIssueLines } from "./issue-format-yh3srOrh.js";
import { r as normalizeTalkSection } from "./talk-BF_qhQLD.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-7gAOW5Ww.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BJUPyqMo.js";
import { n as getLoadedChannelPlugin } from "./registry-B5IDaiMt2.js";
import { i as listRouteBindings } from "./bindings-7pZ7sLXd.js";
...
import { t as note } from "./note-DagUHZ2d.js";
import { i as legacyRuntimeModelAliasRequiresRuntimePolicy, o as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-60a8I8yg.js";
import { t as asObjectRecord } from "./object-CYWMFCVy.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-Cn0iUpzq.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DmZsVtVj.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-IQ1enwsj.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-C8jHXP7a.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BGtJNLKk.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DEoFt0WV.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-WeMoyq8L.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-GperzeOv.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CWXKR-hQ.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CBzNedZ_.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-B-Z4o0Tf.js");
		emitDoctorNotes({
			note,
