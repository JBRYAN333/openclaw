...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-DLWrxK4x.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-xao1_GYl.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { r as setSafeTimeout } from "./timer-delay-H8ims5ZA.js";
import { C as validateChatSendParams, Ni as ErrorCodes, Pi as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-aiM-cUL5.js";
import { s as normalizeInputProvenance } from "./input-provenance-CErWh9lp.js";
...
import { i as resolveSessionFilePath } from "./paths--VbI5S8-.js";
import "./sessions-4cL7r5Dz.js";
import { o as isAudioFileName } from "./mime-CpUb3hFF.js";
import { c as appendSessionTranscriptMessage, o as streamSessionTranscriptLines } from "./transcript-u_C4aNAS.js";
...
import { i as createReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-Dtfv3XOJ.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-BCIwAAWU.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-BvfxoLLB.js";
import { s as normalizeReplyPayloadsForDelivery } from "./deliver-BWG2CP0S.js";
import { c as isNonTerminalAgentRunStatus } from "./subagent-announce-delivery-E3h6uGdD.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-DN2p1HDW.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-DAFxmY0g.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-B97pkbmK.js";
import { C as jsonUtf8Bytes, h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes } from "./session-utils.fs-DHlqTPnd.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-BjvAVv7Z.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-cufcIOI0.js";
import { n as rewriteTranscriptEntriesInSessionFile } from "./context-engine-maintenance-CyRJOuDn.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BB_vDBQI.js";
...
import { t as logLargePayload } from "./diagnostic-payload-BTrLYw8W.js";
import { t as augmentChatHistoryWithCliSessionImports } from "./cli-session-history-D6jIanBy.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CSypX4lv.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-C1k9CmBU.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-CkqwrTBS.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-Rkorv3Ve.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-BhaKF-Cg.js";
import { n as isChatStopCommandText, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BHYS9ooz.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-2wbAd4vH.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-CejskU8R.js";
