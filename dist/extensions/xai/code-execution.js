...
import { n as resolveNormalizedXaiToolModel, r as resolvePositiveIntegerToolConfig } from "../../tool-config-shared-B2SOg0UV.js";
import { i as resolveXaiResponseTextAndCitations, n as buildXaiResponsesToolBody, t as XAI_RESPONSES_ENDPOINT } from "../../responses-tool-shared-akLXeISZ.js";
...
async function requestXaiCodeExecution(params) {
	return await postTrustedWebToolsJson({
		...
		const data = await readProviderJsonResponse(response, "xAI code execution failed");
