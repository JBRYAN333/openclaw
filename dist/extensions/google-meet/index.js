...
async function createMeetFromParams(params) {
	return (await import("../../create-DQnizbQ3.js")).createMeetFromParams(params);
}
async function createAndJoinMeetFromParams(params) {
	return (await import("../../create-DQnizbQ3.js")).createAndJoinMeetFromParams(params);
}
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-wYhIQLws.js");
...
async function exportGoogleMeetBundleFromParams(config, raw) {
	...
	const { buildGoogleMeetExportManifest, googleMeetExportFileNames, writeMeetExportBundle } = await import("../../cli-rN1d41uM.js");
...
var google_meet_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerGoogleMeetCli } = await import("../../cli-rN1d41uM.js");
