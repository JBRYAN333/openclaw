...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Bos-AOxs.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-ByjLBIjB.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-yhImgBb0.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-Dnmatei1.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CfAP2NH_.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DapTaNzx.js");
				return await handleDreamingCommand(api, ctx);
			}
		});
		api.registerCli(async ({ program }) => {
			const { registerMemoryCli } = await import("../../cli-CxcP72rQ.js");
