...
import { t as resolveSystemBin } from "./resolve-system-bin-BK67GFoz.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-DpVbkDsk.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CRwNBVBz.js";
import { t as describeImageWithModel } from "./image-runtime-BPJzkI3w.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-8v9PiTZk.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-VkiB4Rq5.js";
import { n as providerOperationRetryConfig } from "./operation-retry-B97wHLGn.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CMR7mqO2.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-DBFnDz04.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-DZsy_EH5.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
