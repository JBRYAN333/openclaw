...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-CDnIdDwZ.js";
import { n as matrixSetupAdapter } from "./setup-core-C_-UrlRn.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-rXBdbP53.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-B4eXTqZw.js";
import { t as withResolvedActionClient } from "./client-C_pLK-MU.js";
import { r as resolveMatrixAuthContext } from "./config-CeWiP_-Q.js";
import "./client-B8KwhANc.js";
import "./runtime-api-IU17UKGh.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-Du-bHveL.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-D4ZDn_Xm.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-azuKD_jf.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CU591Met.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-DKFrr-RP.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DsjfDxRG.js");
