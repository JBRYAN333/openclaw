...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-BGGtlWHl.js";
import "./config-oTV0PYPe.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-CMob5DtX.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Bjff_0oS.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-D3vCbZqA.js";
import { n as isToolAllowed } from "./tool-policy-BhxZahpr.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-YgW65uIq.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DwkS9Jj-.js";
import { f as isSameSsrFPolicy } from "./ssrf-B0MzL7V8.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-DJPOEy1J.js";
import { C as readRegistry, D as updateRegistry, E as updateBrowserRegistry, O as computeSandboxBrowserConfigHash, S as readBrowserRegistry, T as removeRegistryEntry, _ as resolveSandboxScopeKey, a as execDocker, c as isDockerDaemonUnavailable, g as resolveSandboxAgentId, h as appendWorkspaceMountArgs, l as readDockerContainerEnvVar, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as resolveSandboxWorkspaceDir, w as removeBrowserRegistryEntry, y as slugifySessionKey } from "./docker-Cixz4UjF.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Bacn78KA.js";
import { D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, b as relativePathEscapesContainerRoot, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedMkdirpPlan, y as normalizeContainerPath } from "./browser-bridges-Dnb_4P7W.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-AVPv7r8_.js"),
				import("./exec-defaults-BLkf-dZQ.js"),
				import("./skills-CJBntwrT.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-DMVeOUJQ.js")).maybePruneSandboxes(cfg);
