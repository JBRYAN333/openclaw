...
import { o as isPrivateOrLoopbackHost } from "./net-BlyVdi7u.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BQNfKSOi.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-bhoHm17-.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-TqCbLnZw.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CuLsR_WE.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-CNfnXGYw.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-CelHG87T.js";
import { n as updateMatrixAccountConfig } from "./config-update-CDnIdDwZ.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DbC1Wj2W.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-Bhk2tFPT.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-CqaMY6Fx.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DsjfDxRG.js");
