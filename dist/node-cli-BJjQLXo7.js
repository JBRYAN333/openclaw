...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-Bg8oKLs_.js";
...
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-D_T6PBBQ.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-B0IwYYDj.js";
import "./config-oTV0PYPe.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-CBdAY9vx.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-CsX2SgWk.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-DsGCXEG3.js";
import { t as parsePort } from "./parse-port-kbe5Nitw.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-G38VuP_R.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BNdrbZnr.js";
import { a as getActivePluginRegistry } from "./runtime-BPjDTxSm.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-Cqsw1dpb.js";
import { t as getMachineDisplayName } from "./machine-name-BywYDwiO.js";
import { c as describeInterpreterInlineEval } from "./risks-D5DekXqv.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-CW1m2XYe.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-DxbKSrao.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BqqAO_mD.js";
import { t as formatHelpExamples } from "./help-format-BhZEwqQ0.js";
import { n as detectPolicyInlineEval } from "./policy-Chg7zsRG.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-ovdaMWF3.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-xhxnQ4WG.js";
import { t as resolveNodeService } from "./node-service-DStg7Z3t.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-Dh-5IrtT.js");
