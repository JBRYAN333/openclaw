...
import { r as assertOkOrThrowHttpError, u as readProviderJsonResponse } from "./provider-http-errors-Di3cFtvs.js";
import { d as requireTranscriptionText, p as resolveProviderHttpRequestConfig, t as buildAudioTranscriptionFormData, u as postTranscriptionRequest } from "./shared-BirIU15C.js";
...
async function transcribeOpenAiCompatibleAudio(params) {
	...
	try {
		...
		return {
			text: requireTranscriptionText((await readProviderJsonResponse(res, "Audio transcription failed")).text, "Audio transcription response missing text"),
			model
		};
	} finally {
		await release();
