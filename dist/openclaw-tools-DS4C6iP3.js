...
import { l as redactToolPayloadText } from "./redact-CDZ_xiJS.js";
...
import { n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BtdxzKSb.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-akHIaV5z.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-M9JN_JCw.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-C67EfCIn.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-FFvUEIDc.js";
...
import { t as logDebug } from "./logger-C8cLKnKG.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-CG786ii-.js";
import { h as isWindowsDrivePath } from "./archive-k5tVcBMG.js";
import { n as modelKey } from "./model-ref-shared-Dx3KiJuR.js";
...
import { o as normalizeChannelId } from "./registry-Bd8UHhG1.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DLWrxK4x.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-xao1_GYl.js";
import { u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-G38VuP_R.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-CErWh9lp.js";
import { i as callGateway } from "./call-BiNMiNMp.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-dp1EyOTH.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-fnSpyIry.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-LwF2xSS-.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CksFaaR6.js";
import { n as assertSandboxPath } from "./sandbox-paths-CMob5DtX.js";
import "./local-file-access-CfPX1Kqm.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-CLzrkYvs.js";
import { h as stringifyRouteThreadId } from "./channel-route-kKAHigG3.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-B7f3sDqS.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths--VbI5S8-.js";
import { t as loadSessionStore, w as parseSessionThreadInfoFast } from "./store-load-O_Rv9hrE.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-B5IDaiMt2.js";
import { n as resolveSessionConversationRef } from "./session-conversation-D-Em2Uw9.js";
...
import { c as extractDeliveryInfo } from "./sessions-4cL7r5Dz.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-CpUb3hFF.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-C-TGBz6u.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DkgaMdkF.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-BC9Iw2qZ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BJ5UiGP5.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog, s as resolveDefaultModelForAgent } from "./model-selection-KS3DWjxX.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-BAN84w55.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-CiXe6X6p.js";
import { r as loadModelCatalog } from "./model-catalog-BdYRT-os.js";
import { t as completionRequiresMessageToolDelivery } from "./completion-delivery-policy-BMPFfhf3.js";
import { n as extractTextFromChatContent } from "./chat-content-Bz7eZbDL.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-B20Kxs27.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-CrCS1OnH.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BI1eJiqi.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-9OfUSqSe.js";
...
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bmd2OpRs.js";
import "./tool-policy-fYoy2PZL.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-DAG_sNzB.js";
import { a as resolvePluginTools } from "./tools-DhAnnc4_.js";
import { a as getImageMetadata } from "./image-ops-l_NaT_uv.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-C4vJDCIs.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CYe1PpS_.js";
import { c as isToolWrappedWithBeforeToolCallHook, h as listChannelSupportedActions, p as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-mfHnb-h9.js";
...
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-6mCI0klV.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BVlwj8Wj.js";
import "./auth-profiles-B6McMKCg.js";
import { n as resolveApiKeyForProfile } from "./oauth-DJpWvMWU.js";
import { n as listProfilesForProvider } from "./profile-list-MBXR56b7.js";
import { i as resolveAuthProfileOrder } from "./order-DPONMPot.js";
import { r as getApiKeyForModel } from "./model-auth-DEYN7V2A.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DdMD9NR1.js";
import { n as extractAssistantText } from "./pi-embedded-utils-C_BSOqDJ.js";
import { i as loadSessionEntryByKey, m as mediaUrlsFromGeneratedAttachments, p as formatGeneratedAttachmentLines, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-E3h6uGdD.js";
import { n as runWithImageModelFallback } from "./model-fallback-DonaAKJ1.js";
import "./delivery-context-CpkFk3Rh.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BPQimWgT.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-CIZ9kesq.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-CiAQk4FU.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-D_g5wFc8.js";
import { o as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-Cjas8Qby.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-Crlh5cc4.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BJv-uyer.js";
import { r as stripToolMessages } from "./chat-history-text-DSh72Of8.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-Bb_xxxPM.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CZMuowv-.js";
import { t as inferLegacyName } from "./normalize-T6ALbz7O.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-C8vTheSN.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-COTcPwYC.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-DmApJefF.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-CX1l_f-c.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-D9ThiT2L.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-B7wtKsmr.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-BRLv7gXg.js";
import { u as saveMediaBuffer } from "./store-DN2p1HDW.js";
import { t as SsrFBlockedError } from "./ssrf-B0MzL7V8.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-BqlVf8b6.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CAfERrPG.js";
import { r as getDefaultLocalRoots } from "./local-media-access-B97pkbmK.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-Bak0yBT7.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-DaVCR0vd.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-Byr0S11B.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-I4WP_fYs.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CRwNBVBz.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DhibaOfY.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BPJzkI3w.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-8v9PiTZk.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-CB_rzSsd.js";
import { s as resolveTimeoutMs } from "./resolve-VkiB4Rq5.js";
import { t as buildProviderRegistry } from "./runner-D27AgiyD.js";
import "./media-understanding-C5ULV8vj.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-lxyfQkqE.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-o4iw1XO8.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-Cme8IajH.js";
import { a as resolveAllowedMessageActions, n as runMessageAction, o as POLL_CREATION_PARAM_DEFS, s as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-sZg9zPLi.js";
import { c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, l as findAcpUnsupportedInheritedToolDeny, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CtzUBaa2.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-De65AFYM.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-DXkSu3mh.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-BzzVrbxj.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-DkRc0yIF.js";
import { t as parseTimeoutMs } from "./parse-timeout-CV3S0bbF.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-CbomZKQu.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-OSKuCkol.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-COP9jqJY.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-DHlqTPnd.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-BjvAVv7Z.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BgrXK4rY.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BaDpERsw.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-CwmGFafN.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-BXek9ai9.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-D30Ak4u9.js";
import { _ as isReplySkip, f as runAgentStep, g as isNonDeliverableSessionsReply, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-session-cleanup-B6SEY1YI.js";
...
import { p as registerSubagentRun } from "./subagent-registry-CLTiJFGo.js";
import { i as normalizeSubagentTaskName, n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-BJSNjpOd.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-MEFJs3Lp.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BSz9lxVR.js";
import { k as textToSpeech } from "./tts-runtime-Cpi-RFY7.js";
import "./tts-DjmtpvtB.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-CgNhPC9W.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-XVm6F22M.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DzAOlN9a.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-C0AQPnRX.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CvrpymhN.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CwyRr5fO.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-zv6suiFc.js";
import { i as runWebSearch } from "./runtime-BSmmKc4i.js";
import "./web-search-provider-common-CAPa3L2Z.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-C5UATVgs.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DjPi8dDN.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-B40IIQLC.js"));
