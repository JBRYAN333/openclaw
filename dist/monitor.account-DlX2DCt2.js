...
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-BCIwAAWU.js";
import { s as formatReasoningMessage } from "./pi-embedded-utils-C_BSOqDJ.js";
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./channel-streaming-ClXzZKIW.js";
...
import { n as resolveAgentOutboundIdentity } from "./identity-BHdEZYjM.js";
import "./outbound-runtime-CYqpemcz.js";
import { i as installRequestBodyLimitGuard } from "./http-body-r3ZCVbPH.js";
import "./ssrf-runtime-Dth-2BO1.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-BeyWbmiY.js";
...
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-vUieGQJI.js";
import { t as buildFeishuConversationId } from "./conversation-id-Dci2Ztph.js";
import { i as resolveReceiveIdType } from "./targets-C1zmhCUm.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-Beez_ZvX.js";
import { _ as readString$2, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$2, y as buildFeishuCommentTarget } from "./accounts-bNjJUh2v.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-IyR520Zk.js";
import { a as resolveFeishuGroupSenderActivationIngressAccess, i as resolveFeishuGroupConversationIngressAccess, n as resolveFeishuDmIngressAccess, r as resolveFeishuGroupConfig, s as resolveFeishuReplyPolicy, t as hasExplicitFeishuGroupConfig } from "./policy-7lXRDlwc.js";
import { t as getFeishuRuntime } from "./runtime-DZvEK5Xf.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-DT7YwuMy.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-BrOmHRoh.js";
import "./runtime-api-DgLOM6ts.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-DP6kwJKl.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-L8UrgTus.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-C3xKjbI0.js";
...
async function handleFeishuMessage(params) {
	...
	try {
		...
		const inboundHistory = isGroup && historyKey && historyLimit > 0 && chatHistories ? buildInboundHistoryFromMap({
			historyMap: chatHistories,
			historyKey,
			limit: historyLimit
		}) : void 0;
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DvHHRfvp.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DvHHRfvp.js");
