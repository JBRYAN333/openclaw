...
import { n as getActivePluginChannelRegistrySnapshotFromState } from "./runtime-channel-state-CvlMoagu.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-Bx_jFaj-.js")]);
