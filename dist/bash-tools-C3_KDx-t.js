...
import { a as logWarn, r as logInfo } from "./logger-C8cLKnKG.js";
import { Y as getShellPathFromLoginShell, Z as resolveShellEnvFallbackTimeoutMs } from "./io-CG786ii-.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-D_T6PBBQ.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-B0IwYYDj.js";
import { t as killProcessTree } from "./kill-tree-DR6DtMJe.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { n as APPROVALS_SCOPE, o as WRITE_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-B7f3sDqS.js";
import { d as sanitizeUserFacingText, f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText } from "./sanitize-user-facing-text-DYDcLDnF.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-BZYrqs9n.js";
import { d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Bmd2OpRs.js";
import { t as formatDurationCompact } from "./format-duration-Ds4Btm62.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-ErJubQR8.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-C4MMe_NH.js";
import { o as failedTextResult, y as textResult } from "./common-6mCI0klV.js";
import { t as callGatewayTool } from "./gateway-BVlwj8Wj.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-D5DekXqv.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-CW1m2XYe.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DxbKSrao.js";
import { E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovals, T as requiresExecApproval, c as hasDurableExecApproval, d as maxAsk, h as normalizeExecAsk, k as resolveExecApprovalsFromFile, o as addDurableCommandApproval, p as minSecurity, u as loadExecApprovals, w as requireValidExecTarget, x as recordAllowlistMatchesUse, y as persistAllowAlwaysPatterns } from "./exec-approvals-CEJ2zzEu.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-Ce0peDOj.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-C15uEBMK.js";
import "./delivery-context-CpkFk3Rh.js";
import { t as sendMessage } from "./message-Bdx-Eqv2.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-biJuOiX4.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-OSKuCkol.js";
import { r as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-BNusLUBQ.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-Dgn4UtVr.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-D8UIhMGb.js";
import { t as getProcessSupervisor } from "./supervisor-DykiWkxE.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-CuDOEzZz.js";
import { n as detectPolicyInlineEval } from "./policy-Chg7zsRG.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-DRkezwEU.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-ovdaMWF3.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-15ly--eI.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-SZhVdGxm.js";
