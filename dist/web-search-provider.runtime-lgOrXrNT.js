...
import { _ as readStringParam, p as readNumberParam } from "./common-6mCI0klV.js";
import { u as readProviderJsonResponse } from "./provider-http-errors-Di3cFtvs.js";
import { a as wrapWebContent } from "./external-content-C0AQPnRX.js";
import { i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-zv6suiFc.js";
import { u as postTrustedWebToolsJson } from "./web-search-provider-common-CAPa3L2Z.js";
import "./provider-http-ctoH8Sn3.js";
import { i as resolveProviderWebSearchPluginConfig, r as mergeScopedSearchConfig, t as getScopedCredentialValue } from "./web-search-provider-config-qFswhz4b.js";
import { n as resolveWebSearchProviderCredential } from "./provider-web-search-Bl9sr-1B.js";
import { t as normalizeXaiModelId } from "./model-id-C9Rv3TvT.js";
import "./tool-config-shared-B2SOg0UV.js";
import { n as setPluginXSearchConfigValue, t as resolveEffectiveXSearchConfig } from "./x-search-config-C2OMUrCz.js";
import { a as resolveXaiResponseTextCitationsAndInline, n as buildXaiResponsesToolBody, o as resolveXaiResponsesEndpoint, r as extractXaiWebSearchContent } from "./responses-tool-shared-akLXeISZ.js";
import { t as XAI_DEFAULT_X_SEARCH_MODEL } from "./x-search-shared-DF4dmvpu.js";
...
async function requestXaiWebSearch(params) {
	return await postTrustedWebToolsJson({
		...
		return resolveXaiResponseTextCitationsAndInline(await readProviderJsonResponse(response, "xAI web search failed"), params.inlineCitations);
