...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BI5_8lLP.js";
...
import { a as resolveSecretRefValue } from "./resolve-C3hN93aW.js";
import { n as info, o as success, t as danger } from "./globals-DWuYrGxY.js";
import { U as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot, w as validateConfigObjectRawWithPlugins, x as collectUnsupportedSecretRefPolicyIssues } from "./io-CG786ii-.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-CBdAY9vx.js";
import { n as redactConfigObject } from "./redact-snapshot-Dh_uFUvc.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-npxK1GXa.js";
import { n as setCommandJsonMode } from "./json-mode-B5Id-JXP.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BHxwA2w_.js");
