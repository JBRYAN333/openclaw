...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-BtdxzKSb.js";
...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-DzQOPUGX.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-C5UATVgs.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
