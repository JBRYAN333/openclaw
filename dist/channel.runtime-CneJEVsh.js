...
import { t as countOutboundMedia, u as isReasoningReplyPayload } from "./reply-payload-BCIwAAWU.js";
import { T as resolveChannelStreamingPreviewToolProgress, s as formatChannelProgressDraftLineForEntry } from "./channel-streaming-ClXzZKIW.js";
...
import { n as createDebugProxyWebSocketAgent, r as resolveDebugProxySettings } from "./env-Bs5DhvnG.js";
import "./error-runtime-BebVZAVc.js";
import { n as captureWsEvent } from "./runtime-DCkvnjiQ.js";
import "./proxy-capture-Cs7EvWoH.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import "./routing-CTmNUE0r.js";
import { i as formatInboundFromLabel$1 } from "./envelope-DjDqFexj.js";
...
import { d as ssrfPolicyFromPrivateNetworkOptIn, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-Da3EPITx.js";
...
import "./gateway-runtime-DBjjUQIT.js";
	...
	const handlePost = async (post, payload, messageIds) => {
		...
		if (await processMattermostReplayGuardedPost({
			...
			handlePost: async () => {
				...
				const inboundHistory = historyKey && historyLimit > 0 ? buildInboundHistoryFromMap({
					historyMap: channelHistories,
					historyKey,
					limit: historyLimit
				}) : void 0;
