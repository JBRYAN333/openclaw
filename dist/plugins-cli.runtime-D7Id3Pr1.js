...
import { a as formatMissingPluginMessage } from "./error-format-CBdAY9vx.js";
...
async function runPluginsEnableCommand(id) {
	...
	const { enablePluginInConfig } = await import("./enable-DkvT3FPV.js");
	const { normalizePluginId } = await import("./config-state-JZomYiEe.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-Bbh7hEyy.js");
	const { applySlotSelectionForPlugin, logSlotWarnings } = await import("./plugins-command-helpers-BYFJogsc.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CSw_8rir.js");
...
async function runPluginsDisableCommand(id) {
	...
	const { normalizePluginId } = await import("./config-state-JZomYiEe.js");
	const { buildPluginRegistrySnapshotReport } = await import("./status-Bbh7hEyy.js");
	const { setPluginEnabledInConfig } = await import("./plugins-config-BHV8L05N.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CSw_8rir.js");
	const snapshot = await readConfigFileSnapshot();
	const cfg = snapshot.sourceConfig ?? snapshot.config;
	const report = buildPluginRegistrySnapshotReport({ config: cfg });
...
async function runPluginsInstallAction(raw, opts) {
	await tracePluginLifecyclePhaseAsync("install command", async () => {
		const { runPluginInstallCommand } = await import("./plugins-install-command-D28sB7x6.js");
...
async function runPluginsRegistryCommand(opts) {
	const { inspectPluginRegistry, refreshPluginRegistry } = await import("./plugin-registry-DlVgtd9-.js");
...
async function runPluginsDoctorCommand() {
	const { buildPluginCompatibilityNotices, buildPluginDiagnosticsReport, formatPluginCompatibilityNotice } = await import("./status-Bbh7hEyy.js");
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-llqAtHYR.js");
	const { createPluginInstallLogger } = await import("./plugins-command-helpers-BYFJogsc.js");
