...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-Db3aHzSA.js";
import { n as require_extend, t as require_package$1 } from "./package-BD2lzH65.js";
import { t as require_json_bigint } from "./json-bigint-D1mN0kSI.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-DXq6qpi1.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-D4QBY4u-.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
