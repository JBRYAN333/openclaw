...
import { t as addGatewayServiceCommands } from "./register-service-commands-BdB-MPTp.js";
...
import { a as selectDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-DIqXAABs.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-CV3S0bbF.js";
...
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-CkPUjrSZ.js";
import { n as addGatewayRunCommand } from "./run-FIn1PRR_.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-BVyUsrZG.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-BmnUyaIW.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-DoPrYOVp.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-Caku2ebT.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-YZUPz0EL.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-BfWBixiN.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-CfJK-wJB.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-CjoxvXLo.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-rS1IHsaH.js"));
