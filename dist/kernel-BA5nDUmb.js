...
import { n as createCommandTurnContext, t as commandTurnKindToSource } from "./command-turn-context-DDBgbrzm.js";
import { r as resolveOutboundDurableFinalDeliverySupport } from "./deliver-BWG2CP0S.js";
import { t as normalizeDeliverableOutboundChannel } from "./channel-resolution-BKlIWRlM.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-Bi4VP4gF.js";
import { n as listMessageReceiptPlatformIds } from "./receipt-DqY52yD3.js";
...
import { h as recordPendingHistoryEntryWithMedia, u as clearHistoryEntriesIfEnabled } from "./history-BbynXNYz.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-CUrTydNn.js";
import { a as resolvePairLoopGuardSettings, r as createPairLoopGuard } from "./pair-loop-guard-runtime-Cgaze7ub.js";
import { t as EMPTY_CHANNEL_TURN_DISPATCH_COUNTS } from "./dispatch-result-CgUiR33M.js";
import { r as shouldIncludeSupplementalContext } from "./context-visibility-D0Icl51k.js";
import "./history-window-8x1hgaUD.js";
...
function historyMediaFromInboundFacts(media, messageId) {
...
async function recordDroppedChannelTurnHistory(params) {
	...
	await recordPendingHistoryEntryWithMedia({
		...
		media: typeof media === "function" ? async () => historyMediaFromInboundFacts(await media(), params.input.id) : historyMediaFromInboundFacts(media, params.input.id)
	});
}
...
async function runPreparedChannelTurnCore(params, options) {
	...
	if (botLoopDrop) return botLoopDrop;
	emit({
		...params,
		event: {
			stage: "record",
...
//#endregion
export { runPreparedChannelTurn as a, filterChannelTurnSupplementalContext as c, throwIfDurableInboundReplyDeliveryFailed as d, createChannelDeliveryResultFromReceipt as f, runChannelTurn as i, deliverInboundReplyWithMessageSendContext as l, dispatchAssembledChannelTurn as n, runResolvedChannelTurn as o, recordChannelBotPairLoopAndCheckSuppression as p, recordDroppedChannelTurnHistory as r, buildChannelTurnContext as s, createNoopChannelTurnDeliveryAdapter as t, isDurableInboundReplyDeliveryHandled as u };
