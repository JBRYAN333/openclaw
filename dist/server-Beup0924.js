...
import { p as resolveUserPath, s as ensureDir } from "./utils-CKsuXgDI.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-PGVvvJv_.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-BrbHxAK4.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-C-nwxx53.js");
