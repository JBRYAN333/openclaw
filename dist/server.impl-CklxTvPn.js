...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-CPf_FzsS.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CKsuXgDI.js";
import { c as emitDiagnosticsTimelineEvent, l as isDiagnosticsTimelineEnabled } from "./plugin-metadata-snapshot-Zri3jGSq.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-FFvUEIDc.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BraeyLpn.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-_pvdGtVY.js";
import { t as isContainerEnvironment } from "./container-environment-nBlcuOod.js";
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-BlyVdi7u.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-DVCT1cPn.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-GPf6GUnF.js";
import { n as resolveGatewayAuth } from "./auth-resolve-CbSoM5QC.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-CG786ii-.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-DAXIQoTW.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-BNm5H6G8.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import "./method-scopes-CEFheFOv.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-dp1EyOTH.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Cy_5tEyA.js";
import { C as createPluginGatewayMethodDescriptors, S as createGatewayMethodRegistry, x as createGatewayMethodDescriptorsFromHandlers } from "./loader-LwF2xSS-.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-BPjDTxSm.js";
import { i as resolveMainSessionKey } from "./main-session-CN5vNTUW.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-dw6T05_h.js";
import "./sessions-4cL7r5Dz.js";
import { a as enqueueSystemEvent } from "./system-events-nJrj4YO_.js";
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-DHfs4op1.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-Bw-RpzHf.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-Dm9BBR6x.js";
import { l as getTotalQueueSize } from "./command-queue-CHbM65cH.js";
import { r as resolveCronStorePath } from "./store-F6V6NYct.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-CIZ9kesq.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-B6AYQZeJ.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-D_lJuELb.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dkz9UXJ-.js";
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DwUb-qqR.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-B_5QSG1K.js";
import { t as createDefaultDeps } from "./deps-BHDMPtgP.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BTrLYw8W.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-BLtqTgwz.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-Rkorv3Ve.js";
import { t as GatewayLockError } from "./gateway-lock-Dv1ymbhr.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CRSXePoi.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-r1ZLfmHC.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CY0E46fa.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-Byt1Hc9-.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-DBvY2jYI.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-m44EbSNw.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Csd3y1WD.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-SFZbyXTz.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-D3uh5J48.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-4KYLtzTp.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-FnXK95gn.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-BtcW5dGk.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BOGZAJur.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DVpNsabb.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-Cl5mCwR0.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-uVbokpux.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-By-VnjBi.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-CHdCHG--.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-pOxh1zGv.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-CopGKtMZ.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CpMhoyIV.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-DrcyMWKu.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-DyPpPjjK.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-BoW7jti0.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-d4PFneF-.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-TkBwtSu4.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-B34gG_c9.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-BXKvcUrI.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-BXKvcUrI.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-DvTiK5hX.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CSP7smlf.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-hkPqPrZw.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DNIGmgTL.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-69c5RoTR.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-U3GGq_2I.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DvTiK5hX.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-C61IFelG.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-BQJek_qr.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-sh2ANlLZ.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-DTcgw19N.js");
	const reloadHandlersModulePromise = import("./server-reload-handlers-BZKyppPg.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-COQ3DWle.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-BplcRDCW.js");
	...
	const { createChannelManager } = await import("./server-channels-_T2babMB.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-CYvUyW3j.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-BFaEvaLC.js"), import("./server-runtime-services-DFEUgZkS.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-CeMCgX-3.js");
		const { coreGatewayHandlers } = await import("./server-methods-WBDYfWPF.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-DgwzVfXI.js"),
				import("./server-plugin-bootstrap-Sc3WG1S_.js"),
				import("./services-5rc3dyLH.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-Q8jvdDPI.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-Sc3WG1S_.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-D1lcdo_J.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-DHxYAOom.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-mksTaToP.js");
