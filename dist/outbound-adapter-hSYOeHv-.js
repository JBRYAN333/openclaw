...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-BCIwAAWU.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-B0yiNWm4.js";
...
import { m as DiscordError } from "./discord-B3OV7INV.js";
import { t as chunkDiscordTextWithMode } from "./chunk-BwqTWoQi.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-BneMGHz6.js";
import { t as createDiscordSendReceipt } from "./send.receipt-Dr9aFWhP.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DZDNSVDy.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-B7DRRSSl.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-CovdJigy.js");
