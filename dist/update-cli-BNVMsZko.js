...
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-BqULksTF.js";
import { d as writeJson, i as readJsonIfExists } from "./json-files-1SmAauRO.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-CBX1Vq0w.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DtN_ypvj.js";
import { a as resolvePackageExtensionEntries } from "./manifest-DfoVCJzr.js";
import { r as validatePackageExtensionEntriesForInstall } from "./package-entry-resolution-B4LP9pSd.js";
...
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-BWZLSKg3.js";
import { r as runCommandWithTimeout } from "./exec-DztNbOo9.js";
import { F as asResolvedSourceConfig, I as asRuntimeConfig, K as createPreUpdateConfigSnapshot, p as readSourceConfigBestEffort, u as readConfigFileSnapshot } from "./io-CG786ii-.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-DqLKWd_7.js";
...
import { r as mutateConfigFileWithRetry } from "./mutate-DG7j6ueX.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-XX7BjVe8.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-ZcRvPTPW.js";
import { a as shellEscapeRestartLogValue, i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup } from "./restart-logs-D-q6FQ0E.js";
import "./config-oTV0PYPe.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-CVLoixFZ.js";
import { n as runDaemonInstall } from "./install-CFZ251jr.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-CbJg-XfJ.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-DEU7fzY7.js";
import { u as trimLogTail } from "./restart-sentinel-9OfUSqSe.js";
import { r as formatDurationPrecise } from "./format-duration-Ds4Btm62.js";
import { n as stylePromptMessage } from "./prompt-style-DUcRfPx8.js";
import { t as formatHelpExamples } from "./help-format-BhZEwqQ0.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-De8wXtFH.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BpfQ9qYZ.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveRegistryUpdateChannel, r as channelToNpmTag, s as normalizeUpdateChannel, u as resolveUpdateChannelDisplay } from "./update-channels-BFcNhUpT.js";
import { i as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-BjavQ1mG.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-9h_Mz6Vc.js";
import { i as updateNpmInstalledPlugins, n as resolveTrustedSourceLinkedOfficialNpmSpec, r as syncPluginsForUpdateChannel, t as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./update-U8kenP4Z.js";
import { t as doctorCommand } from "./doctor-Dtxdkxuh.js";
import { t as selectStyled } from "./prompt-select-styled-DnOQuSIN.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-B9OWecZg.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-CFI9oIve.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-Bo472oeb.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-Q_wx-O-s.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-uIfTJgkr.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-Cf_7zgUU.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-BBeuTcNL.js";
import { r as UPDATE_POST_CORE_CONVERGENCE_ENV, t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-BOb5XpI1.js";
...
async function persistRequestedUpdateChannel(params) {
	...
	const mutation = await mutateConfigFileWithRetry({ mutate: (draft) => {
		draft.update = {
			...draft.update,
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-0wCnhoYi.js");
...
async function updateCommand(opts) {
	...
	let postUpdateConfigSnapshot = result.status === "ok" && !opts.dryRun ? await readConfigFileSnapshot() : configSnapshot;
