...
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BtdxzKSb.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-DEwYgSEp.js";
import { l as resolveAgentSkillsFilter, p as resolveSessionAgentId } from "./agent-scope-akHIaV5z.js";
import { u as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Zri3jGSq.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BVSx14Cr.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-YIX-oZq0.js";
import "./config-oTV0PYPe.js";
import { a as normalizeAnyChannelId } from "./registry-Bd8UHhG1.js";
import "./message-channel-core-xao1_GYl.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-DJ_Z5Nbn.js";
import { o as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-CErWh9lp.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-BVtKZVYi.js";
import { t as resolveAgentHarnessPolicy } from "./policy-C4RITkoV.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-sjq8TGmI.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-BErah80O.js";
...
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-B7f3sDqS.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths--VbI5S8-.js";
import { b as resolveMaintenanceConfigFromInput, s as resolveSessionStoreEntry, t as loadSessionStore, w as parseSessionThreadInfoFast } from "./store-load-O_Rv9hrE.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-dw6T05_h.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-B5IDaiMt2.js";
import { f as deriveSessionMetaPatch, g as resolveGroupSessionKey, s as updateSessionStore } from "./store-BiClsopu.js";
import { t as normalizeChatType } from "./chat-type-DaSQwrVS.js";
import "./plugins-CTdP-onY.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-D2bWW4My.js";
import { o as resolveSessionLifecycleTimestamps } from "./sessions-4cL7r5Dz.js";
...
import { t as resolveAndPersistSessionFile } from "./session-file-BKNHyQtc.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-DkgaMdkF.js";
import { h as resolveThinkingDefaultWithRuntimeCatalog } from "./model-selection-KS3DWjxX.js";
import { r as loadModelCatalog } from "./model-catalog-BdYRT-os.js";
import { t as resolveAgentTimeoutMs } from "./timeout-DLsHuJmF.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-DDBgbrzm.js";
import { a as enqueueSystemEvent } from "./system-events-nJrj4YO_.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-CHbM65cH.js";
import { r as getSessionBindingService } from "./session-binding-service-B8tjGRXG.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-xyqWF-9l.js";
import { at as isReasoningTagProvider } from "./selection-CKLE-ex5.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CeiEL6OQ.js";
import { i as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-C6deZo_P.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-CJAZ9XDz.js";
import { r as applyOwnerOnlyToolPolicy } from "./tool-policy-fYoy2PZL.js";
import { i as generateSecureToken } from "./secure-random-CjZPAF5w.js";
import { l as ensureAgentWorkspace } from "./workspace-Bjff_0oS.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-B0XOUrzG.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DwkS9Jj-.js";
import { E as collectTextContentBlocks } from "./attempt.tool-run-context-Da6cUSGm.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-Bu-Izf7L.js";
import "./pi-bundle-mcp-tools-BryQRuC6.js";
import "./delivery-context-CpkFk3Rh.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-Cjas8Qby.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BIPeCrcO.js";
import { n as resolveSilentReplySettings } from "./silent-reply-BNC0TDR-.js";
import { t as buildOutboundSessionContext } from "./session-context-Buj28uA7.js";
import { t as resolveQueueSettings } from "./queue-CPeuEO_w.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-DZaHASqj.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-bFeEiF6C.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-D27kFS2Z.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-Cfy9v0xs.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-DUia7deM.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-BGpBI1xu.js";
import "./commands-registry-CFG-SHhf.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-6M7V7geU.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DtB-1ae1.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BXMikqrG.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-BUMfMf8b.js";
import { t as finalizeInboundContext } from "./inbound-context-CSknn1TM.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CLuIALpO.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-CYu2fH3U.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-C1h6PBIA.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CG2AkfCP.js";
import { t as hasControlCommand } from "./command-detection-DLbcr0iE.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DjDqFexj.js";
...
import { t as normalizeGroupActivation } from "./group-activation-BrXx-kCe.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-BiDxSXX-.js";
import { t as resolveFastModeState } from "./fast-mode-DwJhUMTm.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-BuoZ_EY1.js";
import { t as buildCommandContext } from "./commands-context-Dw8NPgh9.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-DaiVL2ic.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-R4I9Y3LO.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-KQdGlKao.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CnbEBCC6.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-Be9glqWL.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DE2tuQrz.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BoJtNlAP.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-28ZhoGTM.js";
import { t as hasInboundMedia } from "./inbound-media-P2xs3CdH.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-uPfi_WMC.js";
...
import { t as drainFormattedSystemEventBlock } from "./session-system-events-D1hBLi1J.js";
import { r as getCliSessionBinding } from "./cli-session-yQ1geeQL.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-BBIWLTcp.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-CjCvujZL.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-P8QibLLs.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-NzTHT7tl.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-CTyffPBG.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-CFSAAT3p.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-CajN2Lck.js");
...
const hookRunnerGlobalLoader = createLazyImportLoader(() => import("./hook-runner-global-mksTaToP.js"));
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-DDoVqLik.js"));
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-8S8Eqb1u.js");
