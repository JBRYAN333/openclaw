...
const deliverInboundReplyWithMessageSendContext = async (...args) => {
	return await (await import("./kernel-OjerTOZB.js")).deliverInboundReplyWithMessageSendContext(...args);
};
...
async function sendDurableMessageBatch(params) {
	return await (await import("./runtime-CajN2Lck.js")).sendDurableMessageBatch(params);
}
async function withDurableMessageSendContext(params, run) {
	return await (await import("./runtime-CajN2Lck.js")).withDurableMessageSendContext(params, run);
}
