...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-C67EfCIn.js";
...
import { n as resolveProviderAuthAliasMap } from "./provider-auth-aliases-B9-k7vDU.js";
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-BVtKZVYi.js";
...
import { b as resolveProviderEnvAuthEvidence, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-B8eBR-Zy.js";
import "./model-selection-KS3DWjxX.js";
import { t as resolveEnvApiKey } from "./model-auth-env-74I_yqVE.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-CiXe6X6p.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-DEYN7V2A.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-BqVCNAQ5.js";
import { n as loadModelsConfigWithSource } from "./load-config-VWbOKwj3.js";
import { n as formatErrorWithStack } from "./list.errors-hLLzq-OS.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-DIRhAEmj.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-azV7-Sb0.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-Ct1oFcub.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BYqdnt2N.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-BJxP3EZ0.js"),
		import("./agent-scope-CWKjDWHQ.js"),
		import("./workspace-DdfQzkL7.js")
	]);
