...
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-CpUb3hFF.js";
import { r as fetchWithTimeout } from "./fetch-timeout-CAfERrPG.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-C5m-bea7.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-DAFxmY0g.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-CRwNBVBz.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-8v9PiTZk.js";
import { t as providerSupportsCapability } from "./provider-supports-CndIoDZA.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-VkiB4Rq5.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-Cb5Wt9Y5.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CEjFgW9J.js";
import { t as buildRandomTempFilePath } from "./temp-download-2gUFCW5Y.js";
import "./temp-path-BD7h_cnN.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-DGbcILq9.js";
import "./shared-BirIU15C.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BeKhhd2X.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-DBFnDz04.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DZsy_EH5.js");
