...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-C0Hv-9rD.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-KTutXl_g.js";
import { t as formatHelpExamples } from "./help-format-BhZEwqQ0.js";
import { i as registerCommandGroups } from "./register-command-groups-UNgF0DpA.js";
import "./cli-runtime-uNsMewrG.js";
import "./core-api-Diix8qlc.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-Di7CLWsV.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-B2okjnVF.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-CSnhpMz0.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-vhDU_nCh.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-jjrOw5sx.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Cw4XWWm3.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
