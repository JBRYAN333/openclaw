...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-BtdxzKSb.js";
...
import { p as normalizeThinkLevel } from "./thinking-YIX-oZq0.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-BoKW38Mv.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-7ib1D5c0.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-BiNMiNMp.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-C1ybA4qx.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-BI4wQ_1z.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-CpUb3hFF.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-KS3DWjxX.js";
import { r as loadModelCatalog } from "./model-catalog-BdYRT-os.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-l_NaT_uv.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-8v9PiTZk.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-Cpi-RFY7.js";
import "./tts-DjmtpvtB.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DzAOlN9a.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-BSmmKc4i.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-jx5E1Un6.js";
import { t as resolveMemorySearchConfig } from "./memory-search-COxCp9Qs.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CzQweEcF.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CUpLKpek.js";
import { n as runCommandWithRuntime } from "./cli-utils-fczGsp1D.js";
import { t as removeCommandByName } from "./command-tree-DDgIbFcK.js";
import { t as collectOption } from "./helpers-DKWnOIJH.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-CCg_f9xO.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-CI6DBPji.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-XNAwnb7O.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-C46qwmWz.js");
