...
import { o as getResolvedLoggerSettings } from "./logger-CcHExlnD.js";
import { t as danger } from "./globals-DWuYrGxY.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-CG786ii-.js";
import { i as replaceConfigFile } from "./mutate-DG7j6ueX.js";
import "./config-oTV0PYPe.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-CBdAY9vx.js";
...
import { i as getBundledChannelSetupPlugin } from "./bundled-7gAOW5Ww.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-B5IDaiMt2.js";
import "./plugins-CTdP-onY.js";
import "./logging-C_W5e4Yv.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-CCmoGvbo.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CYe1PpS_.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-B43JpCEl.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-3OXh29M7.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-GYH6fRp_.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-CbLGWmmB.js";
import { n as resolveLogFile } from "./log-tail-CPVwAw6F.js";
import { t as parseLogLine } from "./parse-log-line-Dyxfj7lf.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-CN2UcM2_.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-DTKLbwJC.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-C4jW--YO.js";
import { t as channelsListCommand } from "./list-MSPRlxox.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-B1-hiiaV.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-BQ7vh5lm.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BEmI-5sz.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BLqUqZfD.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-Bq3GrThR.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-ClsCund5.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-D77LPtio.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Dm29LL8X.js");
