...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-BvqMC_dX.js";
import "./channel-message-BVwd11Yo.js";
import "./text-autolink-runtime-CnecrLg6.js";
import { t as require_src } from "./src-BAUeJFHj.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-DNOkElr8.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-DaQzzeKs.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-B0RRRtaz.js";
import { t as fromBuffer } from "./lib-CSLFybKw.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CcM_GFXO.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-Dawv-Per.js";
import { l as toRatio, n as decodeString } from "./Util-BHDbOdYA.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-_Wp0Ec-Q.js";
import { t as APEv2Parser } from "./APEv2Parser-ztEqwa1c.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Cg94CRH7.js";
import { i as isStrictDirectRoom } from "./direct-room-CbeD02Y8.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-FCWP-V_N.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D_x14mcW.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DrbE7Oeo.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DjTU6j8J.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Ddvas6Zd.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-C50njpf6.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DR885-_C.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-D061YizY.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-C9lXQkvg.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-vXDK7bq1.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-D6-Zjkau.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-6qJc-GPj.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DQsH501Z.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-zNV8nG5Y.js")).WaveParser;
	}
};
//#endregion
