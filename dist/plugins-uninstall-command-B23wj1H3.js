...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-BWp4jfQn.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-Dd0ydsXf.js");
	const { buildPluginSnapshotReport } = await import("./status-Bbh7hEyy.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-Bz1anQM0.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-DECE1cgH.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CSw_8rir.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BYkzxjnM.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-CR3rxy1q.js");
